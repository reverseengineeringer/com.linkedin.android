...
final class SessionAnalyticsFilesManager
  extends EventsFilesManager<SessionEvent>
{
  ...
  SessionAnalyticsFilesManager(Context paramContext, SessionEventTransform paramSessionEventTransform, CurrentTimeProvider paramCurrentTimeProvider, EventsStorage paramEventsStorage)
    throws IOException
  {
    super(paramContext, paramSessionEventTransform, paramCurrentTimeProvider, paramEventsStorage);
  }
  
  protected final String generateUniqueRollOverFileName()
  {
    UUID localUUID = UUID.randomUUID();
    return "sa_" + localUUID.toString() + "_" + currentTimeProvider.getCurrentTimeMillis() + ".tap";
  }
