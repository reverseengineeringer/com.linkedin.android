...
final class ReportUploader
{
  ...
  final boolean forceUpload(Report paramReport)
  {
    boolean bool2 = false;
    synchronized (fileAccessLock)
    {
      try
      {
        localObject1 = getInstancecontext;
        new ApiKey();
        localObject1 = new CreateReportRequest(ApiKey.getValue((Context)localObject1), paramReport);
  ...
  public final void uploadReports(float paramFloat)
  {
    try
    {
