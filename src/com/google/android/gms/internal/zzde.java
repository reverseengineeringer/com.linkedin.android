...
public final class zzde
{
  ...
  {
    public final void zza(zzjp paramAnonymouszzjp, Map<String, String> paramAnonymousMap) {}
  };
  ...
  public static final zzdf zzza = new zzdf()
  {
    public final void zza(zzjp paramAnonymouszzjp, Map<String, String> paramAnonymousMap)
    {
      ...
      try
      {
        ...
        paramAnonymouszzjp.getContext();
        localObject = ((zzan)localObject).zza$7d090533(paramAnonymousMap);
      ...
      new zziy(paramAnonymouszzjp.getContext(), zzhXafmaVersion, paramAnonymousMap).zzhn();
    }
  };
  ...
  public static final zzdf zzzc = new zzdf()
  {
    public final void zza(zzjp paramAnonymouszzjp, Map<String, String> paramAnonymousMap)
    {
      ...
      if ("checkSupport".equals(paramAnonymousMap.get("action")))
      {
        ...
        boolean bool2 = false;
        paramAnonymousMap = paramAnonymouszzjp.zzhR();
        bool1 = bool2;
        if (paramAnonymousMap != null)
        {
          paramAnonymousMap = zzpy;
          bool1 = bool2;
          if (paramAnonymousMap != null) {
            bool1 = paramAnonymousMap.zzfM();
          }
        }
      ...
      try
      {
        ...
        paramAnonymousMap.put("supports", bool1);
        paramAnonymouszzjp.zzb("appStreaming", paramAnonymousMap);
        return;
      }
      catch (Throwable paramAnonymouszzjp) {}
      paramAnonymouszzjp.zzhS();
      return;
    }
  };
  ...
  public static final zzdf zzzh = new zzdf()
  {
    public final void zza(zzjp paramAnonymouszzjp, Map<String, String> paramAnonymousMap)
    {
      zzbp localzzbp = zzbt.zzwT;
      if (!((Boolean)zzr.zzbL().zzd(localzzbp)).booleanValue()) {
        return;
      }
