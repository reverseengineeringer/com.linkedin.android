    ...
    throws RemoteException
  {
    ...
    case 1: 
      ...
      if (paramParcel1.readInt() != 0)
      {
        ...
        localObject1 = zzi.zzc(paramParcel1);
        if (paramParcel1.readInt() == 0) {
          break label298;
        }
        localObject2 = AdRequestParcel.CREATOR;
      }
      for (localObject2 = zzg.zzb(paramParcel1);; localObject2 = null)
      {
    ...
    case 3: 
      ...
      if (paramParcel1.readInt() != 0)
      {
        ...
        localObject1 = zzg.zzb(paramParcel1);
      }
    ...
    case 7: 
      ...
      for (localObject1 = zzg.zzb(paramParcel1);; localObject1 = null)
      {
    ...
    case 10: 
      ...
      {
        localObject1 = AdRequestParcel.CREATOR;
        localObject2 = zzg.zzb(paramParcel1);
      ...
      for (;;)
      {
        zza(localzzd, (AdRequestParcel)localObject2, str, (zza)localObject1, paramParcel1.readString());
        paramParcel2.writeNoException();
        return true;
        localObject2 = null;
        break;
        ...
        if ((localObject3 != null) && ((localObject3 instanceof zza))) {
          localObject1 = (zza)localObject3;
        } else {
          localObject1 = new zza.zza.zza((IBinder)localObject1);
        }
      }
    case 11: 
      paramParcel1.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapter");
    ...
    case 14: 
      ...
      for (localObject2 = zzj.zze(paramParcel1);; localObject2 = null)
      {
        zza(localzzd, (AdRequestParcel)localObject1, str, (String)localObject3, localzzez, (NativeAdOptionsParcel)localObject2, paramParcel1.createStringArrayList());
        paramParcel2.writeNoException();
        return true;
        localObject1 = null;
        break;
