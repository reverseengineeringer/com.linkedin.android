  ...
  extends Handler
{
  ...
  public void handleMessage(Message paramMessage)
  {
    ...
    if ("com.google.android.c2dm.intent.REGISTRATION".equals(paramMessage.getAction())) {
      GoogleCloudMessaging.zza(zzaLV).add(paramMessage);
    }
    while (GoogleCloudMessaging.zza(zzaLV, paramMessage)) {
      return;
    }
    paramMessage.setPackage(GoogleCloudMessaging.zzb(zzaLV).getPackageName());
    GoogleCloudMessaging.zzb(zzaLV).sendBroadcast(paramMessage);
  }
}
