...
public class zze
{
  ...
  public static int isGooglePlayServicesAvailable(Context paramContext)
  {
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        try
        {
          ...
          if (zzf.zza(localPackageInfo, zzd.zzd.zzafK) != null) {
            break label173;
          }
    ...
    try
    {
      paramContext = zzf.zza(localPackageManager.getPackageInfo("com.android.vending", 8256), zzd.zzd.zzafK);
    ...
    if (zzf.zza(localThrowable, new zzd.zza[] { paramContext }) == null)
    {
      Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
      return 9;
    }
  ...
  public static boolean zzap(Context paramContext)
  {
    ...
    return (zzne.zzcp(21)) && (paramContext.hasSystemFeature("cn.google"));
  }
    ...
    for (boolean bool = true;; bool = false) {
      synchronized (zzqy)
      {
        ...
        try
        {
          ...
          zzf.zzoO();
          if (zzf.zza(paramPackageManager, new zzd.zza[] { zzd.zzd.zzafK[1] }) != null) {}
  ...
  public static boolean zzf(Context paramContext, int paramInt)
  {
    ...
    do
    {
      do
      {
          ...
          for (;;)
          {
            ...
            try
            {
              ...
              if (localObject != null)
              {
                ...
                return zzf.zza((PackageInfo)localObject, true);
              }
            }
            catch (PackageManager.NameNotFoundException paramContext) {}
          }
        ...
        return false;
        bool2 = zzf.zza((PackageInfo)localObject, false);
        bool1 = bool2;
      } while (bool2);
      bool1 = bool2;
    } while (!zzf.zza((PackageInfo)localObject, true));
