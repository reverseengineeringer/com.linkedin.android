    ...
    implements zzm
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        for (localObject1 = zzk.zzfN(paramParcel1);; localObject1 = null)
        {
          if (paramParcel1.readInt() != 0)
          {
            localObject2 = AppMetadata.CREATOR;
            localObject2 = zzb.zzfL(paramParcel1);
          }
      ...
      case 2: 
        ...
        for (localObject1 = zzah.zzfO(paramParcel1);; localObject1 = null)
        {
      ...
      case 4: 
        ...
        if (paramParcel1.readInt() != 0)
        {
          ...
          localObject1 = zzb.zzfL(paramParcel1);
        }
      ...
      case 5: 
        ...
        {
          localObject1 = EventParcel.CREATOR;
          localObject1 = zzk.zzfN(paramParcel1);
        }
      ...
      implements zzm
    {
      ...
      public final List<UserAttributeParcel> zza(AppMetadata paramAppMetadata, boolean paramBoolean)
        throws RemoteException
      {
        int i = 1;
