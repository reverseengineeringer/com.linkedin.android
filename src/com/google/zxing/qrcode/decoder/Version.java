...
public final class Version
{
  ...
  private Version(int paramInt, int[] paramArrayOfInt, ECBlocks... paramVarArgs)
  {
    ...
    int i = 0;
    int j = 0ecCodewordsPerBlock;
    paramArrayOfInt = 0ecBlocks;
    int k = paramArrayOfInt.length;
    paramInt = 0;
    while (paramInt < k)
    {
      paramVarArgs = paramArrayOfInt[paramInt];
      i += count * (dataCodewords + j);
      paramInt += 1;
    }
    totalCodewords = i;
  }
  ...
  public final ECBlocks getECBlocksForLevel(ErrorCorrectionLevel paramErrorCorrectionLevel)
  {
