...
public final class ProfileHighlightActionEvent
  implements RecordTemplate<ProfileHighlightActionEvent>
{
  public static final ProfileHighlightActionEventBuilder BUILDER = ProfileHighlightActionEventBuilder.INSTANCE;
  ...
  public final boolean hasHighlightTracking;
  public final boolean hasMobileHeader;
  public final boolean hasRequestHeader;
  public final EventHeader header;
  public final TrackingObject highlightTracking;
  public final MobileHeader mobileHeader;
  public final UserRequestHeader requestHeader;
  
  ProfileHighlightActionEvent(EventHeader paramEventHeader, UserRequestHeader paramUserRequestHeader, MobileHeader paramMobileHeader, TrackingObject paramTrackingObject, String paramString, ActionCategory paramActionCategory, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6)
  {
    header = paramEventHeader;
    requestHeader = paramUserRequestHeader;
    mobileHeader = paramMobileHeader;
    highlightTracking = paramTrackingObject;
    controlUrn = paramString;
    actionCategory = paramActionCategory;
    hasHeader = paramBoolean1;
    hasRequestHeader = paramBoolean2;
    hasMobileHeader = paramBoolean3;
    hasHighlightTracking = paramBoolean4;
    hasControlUrn = paramBoolean5;
    hasActionCategory = paramBoolean6;
    _cachedId = null;
  }
  
  private ProfileHighlightActionEvent accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    else
    {
      ...
      {
        paramDataProcessor.startRecordField$505cff1c("highlightTracking");
        if (!paramDataProcessor.shouldAcceptTransitively()) {
          break label382;
        }
        localObject1 = highlightTracking.accept(paramDataProcessor);
        label198:
        if (localObject1 == null) {
          break label400;
        }
    ...
    for (boolean bool4 = true;; bool4 = false)
    {
      ...
      localObject4 = localObject1;
      break label158;
      localObject1 = (TrackingObject)paramDataProcessor.processDataTemplate(highlightTracking);
      break label198;
    }
    label406:
    if (!hasRequestHeader) {
    ...
    return new ProfileHighlightActionEvent((EventHeader)localObject2, (UserRequestHeader)localObject3, (MobileHeader)localObject4, (TrackingObject)localObject1, controlUrn, actionCategory, bool1, bool2, bool3, bool4, hasControlUrn, hasActionCategory);
    label501:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ProfileHighlightActionEvent)paramObject;
      if (header != null)
      {
      ...
      if (highlightTracking != null)
      {
        if (highlightTracking.equals(highlightTracking)) {}
      }
      else {
        while (highlightTracking != null) {
          return false;
        }
      }
      if (controlUrn != null)
...
/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.identity.ProfileHighlightActionEvent
