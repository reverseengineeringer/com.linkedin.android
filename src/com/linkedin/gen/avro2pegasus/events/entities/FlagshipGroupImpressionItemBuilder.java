...
public final class FlagshipGroupImpressionItemBuilder
  implements DataTemplateBuilder<FlagshipGroupImpressionItem>
{
  public static final FlagshipGroupImpressionItemBuilder INSTANCE = new FlagshipGroupImpressionItemBuilder();
  ...
  public static FlagshipGroupImpressionItem build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool7) {
      throw new DataReaderException("Failed to find required field: itemTrackingId when building com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem");
    }
    if (!bool6) {
      throw new DataReaderException("Failed to find required field: visibleTime when building com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem");
    }
    if (!bool1) {
      throw new DataReaderException("Failed to find required field: urns when building com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem");
    }
    return new FlagshipGroupImpressionItem((String)localObject4, l2, l1, (GridPosition)localObject3, (ListPosition)localObject2, (EntityDimension)localObject1, localArrayList, bool7, bool6, bool5, bool4, bool3, bool2, bool1);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItemBuilder
