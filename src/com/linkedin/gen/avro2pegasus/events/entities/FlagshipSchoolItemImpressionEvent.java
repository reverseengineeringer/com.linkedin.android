...
public final class FlagshipSchoolItemImpressionEvent
  implements RecordTemplate<FlagshipSchoolItemImpressionEvent>
{
  public static final FlagshipSchoolItemImpressionEventBuilder BUILDER = FlagshipSchoolItemImpressionEventBuilder.INSTANCE;
  ...
  public final List<FlagshipSchoolImpressionItem> items;
  public final MobileHeader mobileHeader;
  public final UserRequestHeader requestHeader;
  public final TrackingObject school;
  
  FlagshipSchoolItemImpressionEvent(EventHeader paramEventHeader, UserRequestHeader paramUserRequestHeader, MobileHeader paramMobileHeader, TrackingObject paramTrackingObject, List<FlagshipSchoolImpressionItem> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5)
  {
  ...
  private FlagshipSchoolItemImpressionEvent accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    else
    {
      ...
      localObject1 = null;
      localFlagshipSchoolImpressionItem = null;
      bool5 = false;
      if (!hasItems) {
        break label501;
      }
      ...
      localObject1 = localFlagshipSchoolImpressionItem;
      ...
      localFlagshipSchoolImpressionItem = (FlagshipSchoolImpressionItem)localIterator.next();
    ...
    label461:
    label471:
    for (FlagshipSchoolImpressionItem localFlagshipSchoolImpressionItem = localFlagshipSchoolImpressionItem.accept(paramDataProcessor);; localFlagshipSchoolImpressionItem = (FlagshipSchoolImpressionItem)paramDataProcessor.processDataTemplate(localFlagshipSchoolImpressionItem))
    {
      if ((localObject1 != null) && (localFlagshipSchoolImpressionItem != null)) {
        ((List)localObject1).add(localFlagshipSchoolImpressionItem);
      }
      i += 1;
      break label287;
    ...
    if (items != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((FlagshipSchoolImpressionItem)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.gen.avro2pegasus.events.entities.FlagshipSchoolItemImpressionEvent", "items");
        }
      }
    }
    return new FlagshipSchoolItemImpressionEvent((EventHeader)localObject2, (UserRequestHeader)localObject3, (MobileHeader)localObject4, (TrackingObject)localObject5, (List)localObject1, bool1, bool2, bool3, bool4, bool5);
    label685:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (FlagshipSchoolItemImpressionEvent)paramObject;
      if (header != null)
      {
...
/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.entities.FlagshipSchoolItemImpressionEvent
