...
public final class FlagshipGroupImpressionItem
  implements RecordTemplate<FlagshipGroupImpressionItem>
{
  public static final FlagshipGroupImpressionItemBuilder BUILDER = FlagshipGroupImpressionItemBuilder.INSTANCE;
  ...
  FlagshipGroupImpressionItem(String paramString, long paramLong1, long paramLong2, GridPosition paramGridPosition, ListPosition paramListPosition, EntityDimension paramEntityDimension, List<String> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6, boolean paramBoolean7)
  {
  ...
  public final FlagshipGroupImpressionItem accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool4 = true;; bool4 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem", "itemTrackingId");
      }
    ...
    if (!hasVisibleTime) {
      throw new MissingRecordFieldException("com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem", "visibleTime");
    }
    if (!hasUrns) {
      throw new MissingRecordFieldException("com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem", "urns");
    }
    if (urns != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((String)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem", "urns");
        }
      }
    }
    return new FlagshipGroupImpressionItem(itemTrackingId, visibleTime, duration, (GridPosition)localObject2, (ListPosition)localObject3, (EntityDimension)localObject4, (List)localObject1, hasItemTrackingId, hasVisibleTime, hasDuration, bool1, bool2, bool3, bool4);
    label659:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (FlagshipGroupImpressionItem)paramObject;
  ...
  public static final class Builder
    implements RecordTemplateBuilder<FlagshipGroupImpressionItem>
  {
    ...
    private FlagshipGroupImpressionItem build(RecordTemplate.Flavor paramFlavor)
      throws BuilderException
    {
      switch (FlagshipGroupImpressionItem.1.$SwitchMap$com$linkedin$data$lite$RecordTemplate$Flavor[paramFlavor.ordinal()])
      {
      }
      while (urns != null)
      {
      ...
      return new FlagshipGroupImpressionItem(itemTrackingId, visibleTime, duration, gridPosition, listPosition, size, urns, hasItemTrackingId, hasVisibleTime, hasDuration, hasGridPosition, hasListPosition, hasSize, hasUrns);
    }
    
    public final FlagshipGroupImpressionItem build()
      throws BuilderException
    {
...
/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.entities.FlagshipGroupImpressionItem
