...
public final class FlagshipSchoolImpressionItemBuilder
  implements DataTemplateBuilder<FlagshipSchoolImpressionItem>
{
  public static final FlagshipSchoolImpressionItemBuilder INSTANCE = new FlagshipSchoolImpressionItemBuilder();
  ...
  public static FlagshipSchoolImpressionItem build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool7) {
      throw new DataReaderException("Failed to find required field: itemTrackingId when building com.linkedin.gen.avro2pegasus.events.entities.FlagshipSchoolImpressionItem");
    }
    if (!bool6) {
      throw new DataReaderException("Failed to find required field: visibleTime when building com.linkedin.gen.avro2pegasus.events.entities.FlagshipSchoolImpressionItem");
    }
    if (!bool1) {
      throw new DataReaderException("Failed to find required field: urns when building com.linkedin.gen.avro2pegasus.events.entities.FlagshipSchoolImpressionItem");
    }
    return new FlagshipSchoolImpressionItem((String)localObject4, l2, l1, (GridPosition)localObject3, (ListPosition)localObject2, (EntityDimension)localObject1, localArrayList, bool7, bool6, bool5, bool4, bool3, bool2, bool1);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.entities.FlagshipSchoolImpressionItemBuilder
