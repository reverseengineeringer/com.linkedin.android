...
public final class WvmpOverviewInsightActionEvent
  implements RecordTemplate<WvmpOverviewInsightActionEvent>
{
  public static final WvmpOverviewInsightActionEventBuilder BUILDER = WvmpOverviewInsightActionEventBuilder.INSTANCE;
  ...
  WvmpOverviewInsightActionEvent(EventHeader paramEventHeader, UserRequestHeader paramUserRequestHeader, MobileHeader paramMobileHeader, TrackingObject paramTrackingObject, String paramString, ActionCategory paramActionCategory, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6)
  {
    header = paramEventHeader;
    requestHeader = paramUserRequestHeader;
    mobileHeader = paramMobileHeader;
    wvmpOverviewInsight = paramTrackingObject;
    controlUrn = paramString;
    actionCategory = paramActionCategory;
    hasHeader = paramBoolean1;
    hasRequestHeader = paramBoolean2;
    hasMobileHeader = paramBoolean3;
    hasWvmpOverviewInsight = paramBoolean4;
    hasControlUrn = paramBoolean5;
    hasActionCategory = paramBoolean6;
    _cachedId = null;
  }
  
  private WvmpOverviewInsightActionEvent accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    return new WvmpOverviewInsightActionEvent((EventHeader)localObject2, (UserRequestHeader)localObject3, (MobileHeader)localObject4, (TrackingObject)localObject1, controlUrn, actionCategory, bool1, bool2, bool3, bool4, hasControlUrn, hasActionCategory);
    label520:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (WvmpOverviewInsightActionEvent)paramObject;
      if (header != null)
      {
  ...
  public final int hashCode()
  {
    ...
    if (header != null)
    {
      ...
      m = wvmpOverviewInsight.hashCode();
      label76:
      if (controlUrn == null) {
        break label170;
      }
...
/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.me.wvmpOverview.WvmpOverviewInsightActionEvent
