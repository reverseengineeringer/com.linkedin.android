...
public final class WvmpProfileViewActionEvent
  implements RecordTemplate<WvmpProfileViewActionEvent>
{
  public static final WvmpProfileViewActionEventBuilder BUILDER = WvmpProfileViewActionEventBuilder.INSTANCE;
  ...
  WvmpProfileViewActionEvent(EventHeader paramEventHeader, UserRequestHeader paramUserRequestHeader, MobileHeader paramMobileHeader, TrackingObject paramTrackingObject, String paramString, ActionCategory paramActionCategory, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6)
  {
    header = paramEventHeader;
    requestHeader = paramUserRequestHeader;
    mobileHeader = paramMobileHeader;
    profileView = paramTrackingObject;
    controlUrn = paramString;
    actionCategory = paramActionCategory;
    hasHeader = paramBoolean1;
    hasRequestHeader = paramBoolean2;
    hasMobileHeader = paramBoolean3;
    hasProfileView = paramBoolean4;
    hasControlUrn = paramBoolean5;
    hasActionCategory = paramBoolean6;
    _cachedId = null;
  }
  
  private WvmpProfileViewActionEvent accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    return new WvmpProfileViewActionEvent((EventHeader)localObject2, (UserRequestHeader)localObject3, (MobileHeader)localObject4, (TrackingObject)localObject1, controlUrn, actionCategory, bool1, bool2, bool3, bool4, hasControlUrn, hasActionCategory);
    label520:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (WvmpProfileViewActionEvent)paramObject;
      if (header != null)
      {
...
/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.me.WvmpProfileViewActionEvent
