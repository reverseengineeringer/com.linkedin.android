...
public final class WvmpOverviewInsightImpressionBuilder
  implements DataTemplateBuilder<WvmpOverviewInsightImpression>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("wvmpOverviewInsight");
  ...
  public static WvmpOverviewInsightImpression build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("wvmpOverviewInsight", JSON_KEY_STORE))
      {
    ...
    if (!bool6) {
      throw new DataReaderException("Failed to find required field: wvmpOverviewInsight when building com.linkedin.gen.avro2pegasus.events.me.wvmp.WvmpOverviewInsightImpression");
    }
    if (!bool4) {
      throw new DataReaderException("Failed to find required field: visibleTime when building com.linkedin.gen.avro2pegasus.events.me.wvmp.WvmpOverviewInsightImpression");
    }
    if (!bool3) {
      throw new DataReaderException("Failed to find required field: duration when building com.linkedin.gen.avro2pegasus.events.me.wvmp.WvmpOverviewInsightImpression");
    }
    if (!bool2) {
      throw new DataReaderException("Failed to find required field: size when building com.linkedin.gen.avro2pegasus.events.me.wvmp.WvmpOverviewInsightImpression");
    }
    return new WvmpOverviewInsightImpression((TrackingObject)localObject4, (ListPosition)localObject3, l2, l1, (EntityDimension)localObject2, (TrackingObject)localObject1, bool6, bool5, bool4, bool3, bool2, bool1);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.gen.avro2pegasus.events.me.wvmp.WvmpOverviewInsightImpressionBuilder
