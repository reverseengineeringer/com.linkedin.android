...
public final class BoltonBuilder
  implements FissileDataModelBuilder<Bolton>, DataTemplateBuilder<Bolton>
{
  public static final BoltonBuilder INSTANCE = new BoltonBuilder();
  ...
  static
  {
    ...
    localHashStringKeyStore.put("boltOnUnion");
  }
  
  public static Bolton build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("boltOnUnion", JSON_KEY_STORE))
      {
        paramDataReader.startField();
        localObject = BoltOnUnionBuilder.INSTANCE;
        localObject = BoltOnUnionBuilder.build(paramDataReader);
        bool = true;
      }
      else
      {
    ...
    if (!bool) {
      throw new DataReaderException("Failed to find required field: boltOnUnion when building com.linkedin.crosspromo.fe.api.android.Bolton");
    }
    return new Bolton((Bolton.BoltOnUnion)localObject, bool);
  }
  
  public static Bolton readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building Bolton");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building Bolton");
    }
    ...
    if (((ByteBuffer)localObject1).getInt() != -80598410)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
      throw new IOException("UID mismatch. Can't read cached data when building Bolton");
    }
    paramString = null;
    localObject2 = null;
    boolean bool1;
    if (((ByteBuffer)localObject1).get() == 1)
    {
      ...
      if (bool1)
      {
        ...
        if (i == 0)
        {
          ...
          localObject2 = BoltOnUnionBuilder.INSTANCE;
          paramString = BoltOnUnionBuilder.readFromFission(paramFissionAdapter, null, paramString, paramFissionTransaction);
          if (paramString == null) {
            break label330;
          }
          bool1 = true;
        ...
        if (i == 1)
        {
          paramString = BoltOnUnionBuilder.INSTANCE;
          paramString = BoltOnUnionBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject1, null, paramFissionTransaction);
          if (paramString == null) {
            break label336;
          }
        }
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      throw new IOException("Failed to find required field: boltOnUnion when reading com.linkedin.crosspromo.fe.api.android.Bolton from fission.");
      bool1 = false;
      break;
      bool1 = false;
      break label267;
    ...
    label342:
    return new Bolton(paramString, bool2);
  }
  
  public static final class BoltOnUnionBuilder
...
/* Location:
 * Qualified Name:     com.linkedin.crosspromo.fe.api.android.BoltonBuilder
