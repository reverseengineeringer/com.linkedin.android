...
public final class JobRecommendationBoltOn
  implements FissileDataModel<JobRecommendationBoltOn>, RecordTemplate<JobRecommendationBoltOn>
{
  public static final JobRecommendationBoltOnBuilder BUILDER = JobRecommendationBoltOnBuilder.INSTANCE;
  ...
  JobRecommendationBoltOn(Image paramImage, RichText paramRichText1, RichText paramRichText2, RichText paramRichText3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    icon = paramImage;
    text = paramRichText1;
  ...
  public final JobRecommendationBoltOn accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool4 = true;; bool4 = false)
    {
      ...
      return new JobRecommendationBoltOn((Image)localObject2, (RichText)localObject3, (RichText)localObject4, (RichText)localObject1, bool1, bool2, bool3, bool4);
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (JobRecommendationBoltOn)paramObject;
      if (icon != null)
      {
        if (icon.equals(icon)) {}
      }
  ...
  public final int getSerializedSize()
  {
    ...
    if (hasIcon)
    {
      if (icon._cachedId != null) {
        i = PegasusBinaryUtils.getEncodedLength(icon._cachedId) + 9;
      }
    }
    else
    {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building JobRecommendationBoltOn");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1169737111);
        if (hasIcon)
        {
          localByteBuffer.put((byte)1);
          if (icon._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.crosspromo.fe.api.bolton.android.JobRecommendationBoltOn
