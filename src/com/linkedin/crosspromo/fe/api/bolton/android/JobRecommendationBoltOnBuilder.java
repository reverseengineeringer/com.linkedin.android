...
public final class JobRecommendationBoltOnBuilder
  implements FissileDataModelBuilder<JobRecommendationBoltOn>, DataTemplateBuilder<JobRecommendationBoltOn>
{
  ...
  public static JobRecommendationBoltOn build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool3) {
      throw new DataReaderException("Failed to find required field: text when building com.linkedin.crosspromo.fe.api.bolton.android.JobRecommendationBoltOn");
    }
    return new JobRecommendationBoltOn((Image)localObject4, (RichText)localObject3, (RichText)localObject2, (RichText)localObject1, bool4, bool3, bool2, bool1);
  }
  
  public static JobRecommendationBoltOn readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building JobRecommendationBoltOn");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building JobRecommendationBoltOn");
    }
    ...
    if (((ByteBuffer)localObject4).getInt() != -1169737111)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject4);
      throw new IOException("UID mismatch. Can't read cached data when building JobRecommendationBoltOn");
    }
    paramString = null;
    ...
    if (((ByteBuffer)localObject4).get() == 1)
    {
      ...
      {
        i = ((ByteBuffer)localObject4).get();
        localObject1 = localRichTextBuilder3;
        bool2 = bool3;
        if (i == 0)
        {
    ...
    label723:
    return new JobRecommendationBoltOn(paramString, (RichText)localObject1, (RichText)localObject2, (RichText)localObject3, bool1, bool2, bool3, bool5);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.crosspromo.fe.api.bolton.android.JobRecommendationBoltOnBuilder
