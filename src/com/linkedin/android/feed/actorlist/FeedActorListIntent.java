...
public final class FeedActorListIntent
  extends IntentFactory<FeedActorListBundleBuilder>
  implements DeeplinkIntent
{
  ...
  {
    return new Intent(paramContext, FeedActorListActivity.class);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.feed.actorlist.FeedActorListIntent
