...
final class BaseFeedFragment$3$1
  implements ModelsTransformedCallback<Update, UpdateDataModel, FeedUpdateViewModel>
{
  BaseFeedFragment$3$1(BaseFeedFragment.3 param3, CollectionTemplate paramCollectionTemplate, DataStore.Type paramType, String paramString) {}
  ...
  public final void onModelsTransformed(ModelsData<Update, UpdateDataModel, FeedUpdateViewModel> paramModelsData)
  {
    ...
    do
    {
      ...
      this$1.this$0.displayInitialUpdates(val$model, viewModels, val$type);
...
/* Location:
 * Qualified Name:     com.linkedin.android.feed.page.feed.BaseFeedFragment.3.1
