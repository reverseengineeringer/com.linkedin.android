...
final class BaseFeedFragment$3$3
  implements ModelsTransformedCallback<Update, UpdateDataModel, FeedUpdateViewModel>
{
  BaseFeedFragment$3$3(BaseFeedFragment.3 param3, CollectionTemplate paramCollectionTemplate, DataStore.Type paramType, String paramString) {}
  ...
  public final void onModelsTransformed(ModelsData<Update, UpdateDataModel, FeedUpdateViewModel> paramModelsData)
  {
    ...
    do
    {
      ...
      BaseFeedFragment localBaseFeedFragment = this$1.this$0;
      paramModelsData = viewModels;
      feedAdapter.appendValues(paramModelsData);
...
/* Location:
 * Qualified Name:     com.linkedin.android.feed.page.feed.BaseFeedFragment.3.3
