...
final class UnfollowEducateAnimationHelper$ShowUnfollowRunnable
  implements Runnable
{
  ...
  UnfollowEducateAnimationHelper$ShowUnfollowRunnable(UnfollowEducateAnimationHelper paramUnfollowEducateAnimationHelper, RecyclerView paramRecyclerView, int paramInt, View paramView)
  {
    view = paramView;
  ...
  {
    Object localObject = this$0.fragmentComponent.activity().getResources();
    ...
    int n = localObject[1];
    localObject = (FeedFragment)this$0.feedUpdatesFragmentWeakReference.get();
    if (n > i) {
      if (n - i > m)
      {
        recyclerView.smoothScrollBy(0, m);
        this$0.fragmentComponent.delayedExecution().postDelayedExecution(this, 100L);
        if ((localObject != null) && (n < j + k) && (this$0.fragmentComponent.activity().applicationComponent.flagshipSharedPreferences().getInsertUnfollowEducateCard()) && (((FeedFragment)localObject).getActivity() != null) && (applicationComponent.flagshipSharedPreferences().getInsertUnfollowEducateCard())) {
          break label237;
        }
      }
    }
...
/* Location:
 * Qualified Name:     com.linkedin.android.feed.utils.animations.UnfollowEducateAnimationHelper.ShowUnfollowRunnable
