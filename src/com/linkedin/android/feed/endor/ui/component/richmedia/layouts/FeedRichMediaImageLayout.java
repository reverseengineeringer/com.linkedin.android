...
public final class FeedRichMediaImageLayout
  extends FeedRichMediaLayout
{
  private final int aspectRatioHeight;
  private final int aspectRatioWidth;
  
  public FeedRichMediaImageLayout(FragmentComponent paramFragmentComponent, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    if (paramBoolean3)
    {
      aspectRatioWidth = paramFragmentComponent.getInteger(2131558447);
      aspectRatioHeight = paramFragmentComponent.getInteger(2131558446);
      return;
    }
    aspectRatioWidth = paramFragmentComponent.getInteger(2131558449);
    aspectRatioHeight = paramFragmentComponent.getInteger(2131558448);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.feed.endor.ui.component.richmedia.layouts.FeedRichMediaImageLayout
