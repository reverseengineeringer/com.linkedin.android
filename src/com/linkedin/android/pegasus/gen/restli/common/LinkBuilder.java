  ...
  implements FissileDataModelBuilder<Link>, DataTemplateBuilder<Link>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("rel");
    JSON_KEY_STORE.put("href");
    ...
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("rel", JSON_KEY_STORE))
      {
        paramDataReader.startField();
        str3 = paramDataReader.readString();
        bool3 = true;
      }
      else if (paramDataReader.shouldReadField$11ca93e7("href", JSON_KEY_STORE))
      {
        paramDataReader.startField();
    ...
    return new Link(str3, str2, str1, bool3, bool2, bool1);
  }
    ...
    throws IOException
  {
    ...
    label170:
    if (((ByteBuffer)localObject1).getInt() != 1988116859)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
    ...
    return new Link(paramString, paramFissionTransaction, (String)localObject2, bool1, bool2, bool3);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.restli.common.LinkBuilder
