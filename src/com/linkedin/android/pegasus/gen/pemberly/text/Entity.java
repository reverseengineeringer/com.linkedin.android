...
public final class Entity
  implements FissileDataModel<Entity>, RecordTemplate<Entity>
{
  ...
  Entity(Urn paramUrn, boolean paramBoolean)
  {
    urn = paramUrn;
    hasUrn = paramBoolean;
    _cachedId = null;
    ...
    throws DataProcessorException
  {
    ...
    if (paramDataProcessor.shouldReturnProcessedTemplate())
    {
      ...
      {
        if (!hasUrn) {
          throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.pemberly.text.Entity", "urn");
        }
      }
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-124907439);
        if (hasUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.pemberly.text.Entity
