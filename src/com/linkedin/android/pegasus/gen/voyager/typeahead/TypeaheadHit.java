...
public final class TypeaheadHit
  implements FissileDataModel<TypeaheadHit>, RecordTemplate<TypeaheadHit>
{
  ...
  TypeaheadHit(AnnotatedText paramAnnotatedText, String paramString, HitInfo paramHitInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    ...
    hasHitInfo = paramBoolean3;
    _cachedId = null;
  }
  
  public final TypeaheadHit accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      localObject2 = localObject1;
      break label56;
      localObject1 = (HitInfo)paramDataProcessor.processDataTemplate(hitInfo);
      break label120;
    }
    label221:
    return new TypeaheadHit((AnnotatedText)localObject2, subtext, (HitInfo)localObject1, bool1, hasSubtext, bool2);
    label243:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (TypeaheadHit)paramObject;
      if (text != null)
      {
        if (text.equals(text)) {}
      }
  ...
  public final int getSerializedSize()
  {
    ...
    else
    {
      ...
      if (hasHitInfo)
      {
        ...
        i = i + 2 + PegasusBinaryUtils.getEncodedLength(hitInfo._cachedId);
      }
    }
    for (;;)
    {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1922300810);
        if (hasText)
        {
          localByteBuffer.put((byte)1);
          if (text._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.typeahead.TypeaheadHit
