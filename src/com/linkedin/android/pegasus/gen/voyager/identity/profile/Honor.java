...
public final class Honor
  implements FissileDataModel<Honor>, RecordTemplate<Honor>
{
  ...
  Honor(Urn paramUrn1, String paramString1, Date paramDate, String paramString2, Urn paramUrn2, String paramString3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6)
  {
    entityUrn = paramUrn1;
    title = paramString1;
    issueDate = paramDate;
  ...
  public final Honor accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.Honor", "title");
      }
    ...
    label255:
    return new Honor(entityUrn, title, (Date)localObject, issuer, occupation, description, hasEntityUrn, hasTitle, bool, hasIssuer, hasOccupation, hasDescription);
    label305:
    return null;
  }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building Honor");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1241899912);
        if (hasEntityUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.Honor
