...
public final class RecentlyEndorsedInfo
  implements FissileDataModel<RecentlyEndorsedInfo>, RecordTemplate<RecentlyEndorsedInfo>
{
  public static final RecentlyEndorsedInfoBuilder BUILDER = RecentlyEndorsedInfoBuilder.INSTANCE;
  ...
  RecentlyEndorsedInfo(List<HighlightsMiniProfile> paramList, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramList == null) {}
  ...
  public final RecentlyEndorsedInfo accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.RecentlyEndorsedInfo", "endorsers");
      }
    ...
    if (!hasTotalCount) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.RecentlyEndorsedInfo", "totalCount");
    }
    if (endorsers != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((HighlightsMiniProfile)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.RecentlyEndorsedInfo", "endorsers");
        }
      }
    }
    return new RecentlyEndorsedInfo((List)localObject, totalCount, bool, hasTotalCount);
    label344:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (RecentlyEndorsedInfo)paramObject;
      if (endorsers != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building RecentlyEndorsedInfo");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(753206001);
        if (hasEndorsers)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.RecentlyEndorsedInfo
