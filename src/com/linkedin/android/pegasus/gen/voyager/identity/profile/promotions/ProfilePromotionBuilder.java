...
public final class ProfilePromotionBuilder
  implements FissileDataModelBuilder<ProfilePromotion>, DataTemplateBuilder<ProfilePromotion>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("prompt");
    JSON_KEY_STORE.put("primaryAction");
    JSON_KEY_STORE.put("secondaryAction");
    JSON_KEY_STORE.put("dismissAction");
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.promotions.ProfilePromotionBuilder
