...
public final class EndorserMiniProfile
  implements FissileDataModel<EndorserMiniProfile>, RecordTemplate<EndorserMiniProfile>
{
  public static final EndorserMiniProfileBuilder BUILDER = EndorserMiniProfileBuilder.INSTANCE;
  ...
  EndorserMiniProfile(MiniProfile paramMiniProfile, MemberDistance paramMemberDistance, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public final EndorserMiniProfile accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    label196:
    return new EndorserMiniProfile((MiniProfile)localObject2, (MemberDistance)localObject1, bool1, bool2);
    label210:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (EndorserMiniProfile)paramObject;
      if (miniProfile != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building EndorserMiniProfile");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(2000907237);
        if (hasMiniProfile)
        {
          localByteBuffer.put((byte)1);
          if (miniProfile._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.EndorserMiniProfile
