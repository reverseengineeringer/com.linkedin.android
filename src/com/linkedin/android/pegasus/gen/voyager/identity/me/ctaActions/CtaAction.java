...
public final class CtaAction
  implements FissileDataModel<CtaAction>, RecordTemplate<CtaAction>
{
  ...
  CtaAction(Action paramAction, boolean paramBoolean)
  {
    action = paramAction;
    hasAction = paramBoolean;
    _cachedId = null;
  }
  
  public final CtaAction accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.ctaActions.CtaAction", "action");
      }
    ...
    label115:
    return new CtaAction(localAction, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (CtaAction)paramObject;
      if (action == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building CtaAction");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1079669506);
        if (hasAction)
        {
          localByteBuffer.put((byte)1);
          if (action._cachedId != null)
    ...
    implements FissileDataModel<Action>, UnionTemplate<Action>
  {
    ...
    Action(MessageAction paramMessageAction, LikeAction paramLikeAction, boolean paramBoolean1, boolean paramBoolean2)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.me.ctaActions.CtaAction
