...
public final class DescriptiveSeniorCompany
  implements FissileDataModel<DescriptiveSeniorCompany>, RecordTemplate<DescriptiveSeniorCompany>
{
  public static final DescriptiveSeniorCompanyBuilder BUILDER = DescriptiveSeniorCompanyBuilder.INSTANCE;
  ...
  DescriptiveSeniorCompany(MiniCompany paramMiniCompany, int paramInt, List<HighlightsMiniProfile> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
  ...
  public final DescriptiveSeniorCompany accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.shared.networkHighlights.DescriptiveSeniorCompany", "company");
      }
    ...
    if (!hasNumConnections) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.shared.networkHighlights.DescriptiveSeniorCompany", "numConnections");
    }
    if (connections != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((HighlightsMiniProfile)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.identity.shared.networkHighlights.DescriptiveSeniorCompany", "connections");
        }
      }
    }
    return new DescriptiveSeniorCompany((MiniCompany)localObject2, numConnections, (List)localObject1, bool1, hasNumConnections, bool2);
    label440:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (DescriptiveSeniorCompany)paramObject;
      if (company != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building DescriptiveSeniorCompany");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      do
      {
        ...
        localByteBuffer.putInt(-1164102670);
        Iterator localIterator;
        if (hasCompany)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.shared.networkHighlights.DescriptiveSeniorCompany
