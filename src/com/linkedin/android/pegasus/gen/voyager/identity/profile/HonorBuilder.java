...
public final class HonorBuilder
  implements FissileDataModelBuilder<Honor>, DataTemplateBuilder<Honor>
{
  public static final HonorBuilder INSTANCE = new HonorBuilder();
  ...
  public static Honor build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool5) {
      throw new DataReaderException("Failed to find required field: title when building com.linkedin.android.pegasus.gen.voyager.identity.profile.Honor");
    }
    return new Honor((Urn)localObject3, str3, (Date)localObject2, str2, (Urn)localObject1, str1, bool6, bool5, bool4, bool3, bool2, bool1);
  }
  
  public static Honor readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building Honor");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building Honor");
    }
    ...
    if (((ByteBuffer)localObject1).getInt() != 1241899912)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
      throw new IOException("UID mismatch. Can't read cached data when building Honor");
    }
    localObject2 = null;
    String str1 = null;
    paramString = null;
    ...
    for (boolean bool6 = true;; bool6 = false)
    {
      ...
      throw new IOException("Failed to find required field: title when reading com.linkedin.android.pegasus.gen.voyager.identity.profile.Honor from fission.");
      bool3 = false;
      break;
      bool4 = false;
      break label264;
    ...
    label540:
    return new Honor((Urn)localObject2, str1, paramString, paramFissionTransaction, (Urn)localObject3, str2, bool3, bool4, bool1, bool2, bool5, bool6);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.HonorBuilder
