...
public final class Publication
  implements FissileDataModel<Publication>, RecordTemplate<Publication>
{
  ...
  Publication(Urn paramUrn, String paramString1, String paramString2, Date paramDate, String paramString3, String paramString4, List<Contributor> paramList, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6, boolean paramBoolean7)
  {
    entityUrn = paramUrn;
    name = paramString1;
  ...
  public final Publication accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    return new Publication(entityUrn, name, publisher, (Date)localObject2, url, description, (List)localObject1, hasEntityUrn, hasName, hasPublisher, bool1, hasUrl, hasDescription, bool2);
    label568:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (Publication)paramObject;
      if (entityUrn != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building Publication");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      do
      {
        ...
        localByteBuffer.putInt(-1389658647);
        Object localObject;
        if (hasEntityUrn)
        {
          localByteBuffer.put((byte)1);
    ...
    implements RecordTemplateBuilder<Publication>
  {
    ...
    public Builder(Publication paramPublication)
    {
      entityUrn = entityUrn;
      name = name;
      publisher = publisher;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.Publication
