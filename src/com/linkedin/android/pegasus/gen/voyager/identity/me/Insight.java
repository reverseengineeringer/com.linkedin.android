  ...
  implements FissileDataModel<Insight>, RecordTemplate<Insight>
{
  ...
  Insight(Value paramValue, Urn paramUrn, String paramString, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    value = paramValue;
    objectUrn = paramUrn;
    ...
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.Insight", "value");
      }
    ...
    label173:
    if (!hasObjectUrn) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.Insight", "objectUrn");
    }
    if (!hasTrackingId) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.Insight", "trackingId");
    }
    return new Insight(localValue, objectUrn, trackingId, bool, hasObjectUrn, hasTrackingId);
    label237:
    return null;
  }
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(96661724);
        if (hasValue)
        {
          localByteBuffer.put((byte)1);
          if (value._cachedId != null)
    ...
    implements FissileDataModel<Value>, UnionTemplate<Value>
  {
    ...
    Value(NetworkHighlight paramNetworkHighlight, WvmpJymbiiInsight paramWvmpJymbiiInsight, ConnectionsInCommonInsight paramConnectionsInCommonInsight, SocialUpdateAnalyticsInsight paramSocialUpdateAnalyticsInsight, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.me.Insight
