...
public final class WvmpJymbiiInsight
  implements FissileDataModel<WvmpJymbiiInsight>, RecordTemplate<WvmpJymbiiInsight>
{
  public static final WvmpJymbiiInsightBuilder BUILDER = WvmpJymbiiInsightBuilder.INSTANCE;
  ...
  WvmpJymbiiInsight(MiniCompany paramMiniCompany, boolean paramBoolean)
  {
  ...
  public final WvmpJymbiiInsight accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.wvmpOverview.WvmpJymbiiInsight", "miniCompany");
      }
    ...
    label115:
    return new WvmpJymbiiInsight(localMiniCompany, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (WvmpJymbiiInsight)paramObject;
      if (miniCompany == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building WvmpJymbiiInsight");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1465606415);
        if (hasMiniCompany)
        {
          localByteBuffer.put((byte)1);
          if (miniCompany._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.me.wvmpOverview.WvmpJymbiiInsight
