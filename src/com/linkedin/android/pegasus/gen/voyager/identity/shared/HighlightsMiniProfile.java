...
public final class HighlightsMiniProfile
  implements FissileDataModel<HighlightsMiniProfile>, RecordTemplate<HighlightsMiniProfile>
{
  public static final HighlightsMiniProfileBuilder BUILDER = HighlightsMiniProfileBuilder.INSTANCE;
  ...
  HighlightsMiniProfile(MiniProfile paramMiniProfile, MemberDistance paramMemberDistance, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public final HighlightsMiniProfile accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.shared.HighlightsMiniProfile", "miniProfile");
      }
    ...
    label196:
    if (!hasDistance) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.shared.HighlightsMiniProfile", "distance");
    }
    return new HighlightsMiniProfile((MiniProfile)localObject2, (MemberDistance)localObject1, bool1, bool2);
    label229:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (HighlightsMiniProfile)paramObject;
      if (miniProfile != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building HighlightsMiniProfile");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(929315271);
        if (hasMiniProfile)
        {
          localByteBuffer.put((byte)1);
          if (miniProfile._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.shared.HighlightsMiniProfile
