...
public final class Action
  implements FissileDataModel<Action>, RecordTemplate<Action>
{
  ...
  Action(Value paramValue, AttributedText paramAttributedText, ActionCategory paramActionCategory, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    value = paramValue;
    displayText = paramAttributedText;
    legoActionCategory = paramActionCategory;
    hasValue = paramBoolean1;
    hasDisplayText = paramBoolean2;
    hasLegoActionCategory = paramBoolean3;
    _cachedId = null;
  }
    ...
    throws DataProcessorException
  {
    ...
    else
    {
      ...
      if (hasDisplayText)
      {
        ...
        localObject1 = displayText.accept(paramDataProcessor);
        label95:
        if (localObject1 == null) {
          break label216;
        }
    ...
    {
      if (hasLegoActionCategory)
      {
        paramDataProcessor.startRecordField$505cff1c("legoActionCategory");
        paramDataProcessor.processEnum(legoActionCategory);
      }
      ...
      localObject2 = localObject1;
      break label56;
      localObject1 = (AttributedText)paramDataProcessor.processDataTemplate(displayText);
      break label95;
    }
    label221:
    return new Action((Value)localObject2, (AttributedText)localObject1, legoActionCategory, bool1, bool2, hasLegoActionCategory);
    label243:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while (legoActionCategory.equals(legoActionCategory));
    for (;;)
    {
      return false;
      if (legoActionCategory == null) {
  ...
  public final int getSerializedSize()
  {
    ...
    if (hasValue)
    {
      if (value._cachedId != null) {
        i = PegasusBinaryUtils.getEncodedLength(value._cachedId) + 9;
      }
    }
    else
    {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1698307703);
        if (hasValue)
        {
          localByteBuffer.put((byte)1);
          if (value._cachedId != null)
          {
            ...
            localByteBuffer.put((byte)1);
            paramFissionAdapter.writeUnsignedShort(localByteBuffer, legoActionCategory.ordinal());
          }
        }
        for (;;)
        {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.promotions.actions.Action
