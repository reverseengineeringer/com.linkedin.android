  ...
  implements FissileDataModel<SharedConnectionsInfo>, RecordTemplate<SharedConnectionsInfo>
{
  ...
  SharedConnectionsInfo(List<HighlightsMiniProfile> paramList, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramList == null) {}
    for (paramList = null;; paramList = Collections.unmodifiableList(paramList))
    {
      ...
      totalCount = paramInt;
      hasSharedConnections = paramBoolean1;
    ...
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo", "sharedConnections");
      }
    ...
    if (!hasTotalCount) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo", "totalCount");
    }
    if (sharedConnections != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((HighlightsMiniProfile)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo", "sharedConnections");
        }
      }
    }
    return new SharedConnectionsInfo((List)localObject, totalCount, bool, hasTotalCount);
    label344:
    return null;
  }
  ...
  public final int hashCode()
  {
    ...
    if (sharedConnections != null) {}
    for (int i = sharedConnections.hashCode();; i = 0)
    {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1611377594);
        if (hasSharedConnections)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo
