...
public final class NormPatent
  implements FissileDataModel<NormPatent>, RecordTemplate<NormPatent>
{
  ...
  NormPatent(Urn paramUrn, String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, boolean paramBoolean1, Date paramDate1, Date paramDate2, String paramString6, String paramString7, List<NormContributor> paramList, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6, boolean paramBoolean7, boolean paramBoolean8, boolean paramBoolean9, boolean paramBoolean10, boolean paramBoolean11, boolean paramBoolean12, boolean paramBoolean13)
  {
    entityUrn = paramUrn;
    number = paramString1;
  ...
  private NormPatent accept(DataProcessor paramDataProcessor)
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (NormPatent)paramObject;
      if (entityUrn != null)
      {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localByteBuffer.putInt(-1520277272);
        Object localObject;
        if (hasEntityUrn)
        {
          localByteBuffer.put((byte)1);
    ...
    implements RecordTemplateBuilder<NormPatent>
  {
    ...
    public Builder(NormPatent paramNormPatent)
    {
      entityUrn = entityUrn;
      number = number;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.NormPatent
