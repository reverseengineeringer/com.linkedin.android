...
public final class ProfileHighlight
  implements FissileDataModel<ProfileHighlight>, RecordTemplate<ProfileHighlight>
{
  ...
  ProfileHighlight(Detail paramDetail, boolean paramBoolean)
  {
    detail = paramDetail;
  ...
  public final ProfileHighlight accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    label115:
    return new ProfileHighlight(localDetail, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ProfileHighlight)paramObject;
      if (detail == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building ProfileHighlight");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-760321279);
        if (hasDetail)
        {
          localByteBuffer.put((byte)1);
          if (detail._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.shared.profileHighlights.ProfileHighlight
