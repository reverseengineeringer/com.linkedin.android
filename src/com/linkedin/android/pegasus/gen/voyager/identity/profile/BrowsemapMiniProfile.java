...
public final class BrowsemapMiniProfile
  implements FissileDataModel<BrowsemapMiniProfile>, RecordTemplate<BrowsemapMiniProfile>
{
  public static final BrowsemapMiniProfileBuilder BUILDER = BrowsemapMiniProfileBuilder.INSTANCE;
  ...
  BrowsemapMiniProfile(MiniProfile paramMiniProfile, MemberDistance paramMemberDistance, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  private BrowsemapMiniProfile accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.BrowsemapMiniProfile", "miniProfile");
      }
    ...
    label196:
    if (!hasDistance) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.BrowsemapMiniProfile", "distance");
    }
    return new BrowsemapMiniProfile((MiniProfile)localObject2, (MemberDistance)localObject1, bool1, bool2);
    label229:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (BrowsemapMiniProfile)paramObject;
      if (miniProfile != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building BrowsemapMiniProfile");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(772453867);
        if (hasMiniProfile)
        {
          localByteBuffer.put((byte)1);
          if (miniProfile._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.BrowsemapMiniProfile
