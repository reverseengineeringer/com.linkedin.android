...
public final class SuggestedEndorsementBuilder
  implements FissileDataModelBuilder<SuggestedEndorsement>, DataTemplateBuilder<SuggestedEndorsement>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("recipient");
    JSON_KEY_STORE.put("endorsedSkillName");
    JSON_KEY_STORE.put("signature");
    JSON_KEY_STORE.put("reason");
  }
  
  public static final class ReasonBuilder
    implements FissileDataModelBuilder<SuggestedEndorsement.Reason>, DataTemplateBuilder<SuggestedEndorsement.Reason>
  {
    ...
    public static SuggestedEndorsement.Reason build(DataReader paramDataReader)
      throws DataReaderException
    {
      ...
      return new SuggestedEndorsement.Reason((SuggestedEndorsementReasonExpert)localObject2, (SuggestedEndorsementReasonStandard)localObject1, bool2, bool1);
    }
    
    public static SuggestedEndorsement.Reason readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
      throws IOException
    {
      if ((paramByteBuffer == null) && (paramString == null)) {
        throw new IOException("Cannot read without at least one of key or input byteBuffer when building SuggestedEndorsement.Reason");
      }
      ...
      if (paramString != null)
      {
        ...
        throw new IOException("Invalid header prefix. Can't read cached data when building SuggestedEndorsement.Reason");
      }
      ...
      if (((ByteBuffer)localObject2).getInt() != -2025818847)
      {
        ...
        throw new IOException("UID mismatch. Can't read cached data when building SuggestedEndorsement.Reason");
      }
      paramString = null;
      ...
      label485:
      return new SuggestedEndorsement.Reason(paramString, (SuggestedEndorsementReasonStandard)localObject1, bool1, bool3);
    }
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.SuggestedEndorsementBuilder
