...
public final class SharedEntityInfo
  implements FissileDataModel<SharedEntityInfo>, RecordTemplate<SharedEntityInfo>
{
  ...
  SharedEntityInfo(List<HighlightsMiniProfile> paramList, int paramInt, SharedEntity paramSharedEntity, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (paramList == null) {}
  ...
  public final SharedEntityInfo accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    return new SharedEntityInfo((List)localObject2, totalCount, (SharedEntity)localObject1, bool1, hasTotalCount, bool2);
    label443:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (SharedEntityInfo)paramObject;
      if (endorsers != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building SharedEntityInfo");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1742512512);
        if (hasEndorsers)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedEntityInfo
