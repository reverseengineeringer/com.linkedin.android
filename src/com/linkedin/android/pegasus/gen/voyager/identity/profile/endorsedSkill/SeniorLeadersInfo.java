...
public final class SeniorLeadersInfo
  implements FissileDataModel<SeniorLeadersInfo>, RecordTemplate<SeniorLeadersInfo>
{
  ...
  SeniorLeadersInfo(List<HighlightsMiniProfile> paramList, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramList == null) {}
  ...
  public final SeniorLeadersInfo accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasLeaders)
    {
      paramDataProcessor.startRecordField$505cff1c("leaders");
      leaders.size();
      ...
      int i = 0;
      Iterator localIterator = leaders.iterator();
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SeniorLeadersInfo", "leaders");
      }
    ...
    if (!hasTotalCount) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SeniorLeadersInfo", "totalCount");
    }
    if (leaders != null)
    {
      paramDataProcessor = leaders.iterator();
      while (paramDataProcessor.hasNext()) {
        if ((HighlightsMiniProfile)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SeniorLeadersInfo", "leaders");
        }
      }
    }
    return new SeniorLeadersInfo((List)localObject, totalCount, bool, hasTotalCount);
    label344:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (SeniorLeadersInfo)paramObject;
      if (leaders != null)
      {
        if (leaders.equals(leaders)) {}
      }
      else {
        while (leaders != null) {
          return false;
  ...
  public final int hashCode()
  {
    ...
    if (leaders != null) {}
    for (int i = leaders.hashCode();; i = 0)
    {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building SeniorLeadersInfo");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-456619150);
        if (hasLeaders)
        {
          localByteBuffer.put((byte)1);
          paramFissionAdapter.writeUnsignedShort(localByteBuffer, leaders.size());
          Iterator localIterator = leaders.iterator();
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SeniorLeadersInfo
