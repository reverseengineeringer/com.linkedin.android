...
public final class ImageCropInfo
  implements FissileDataModel<ImageCropInfo>, RecordTemplate<ImageCropInfo>
{
  public static final ImageCropInfoBuilder BUILDER = ImageCropInfoBuilder.INSTANCE;
  ...
  ImageCropInfo(int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    x = paramInt1;
    y = paramInt2;
    width = paramInt3;
  ...
  public final ImageCropInfo accept(DataProcessor paramDataProcessor)
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ImageCropInfo)paramObject;
      if (x != x) {
        return false;
      }
      if (y != y) {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building ImageCropInfo");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(940633411);
        if (hasX)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.ImageCropInfo
