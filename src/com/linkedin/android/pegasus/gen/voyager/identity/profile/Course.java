...
public final class Course
  implements FissileDataModel<Course>, RecordTemplate<Course>
{
  ...
  Course(Urn paramUrn1, String paramString1, String paramString2, Urn paramUrn2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    entityUrn = paramUrn1;
    name = paramString1;
    number = paramString2;
  ...
  public final Course accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (paramDataProcessor.shouldReturnProcessedTemplate())
    {
      ...
      {
        if (!hasName) {
          throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.profile.Course", "name");
        }
      }
      ...
      return new Course(entityUrn, name, number, occupation, hasEntityUrn, hasName, hasNumber, hasOccupation);
    }
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (Course)paramObject;
      if (entityUrn != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building Course");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-812925405);
        if (hasEntityUrn)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.Course
