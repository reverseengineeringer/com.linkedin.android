  ...
  implements FissileDataModelBuilder<SharedConnectionsInfo>, DataTemplateBuilder<SharedConnectionsInfo>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("sharedConnections");
    ...
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("sharedConnections", JSON_KEY_STORE))
      {
    ...
    if (!bool2) {
      throw new DataReaderException("Failed to find required field: sharedConnections when building com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo");
    }
    if (!bool1) {
      throw new DataReaderException("Failed to find required field: totalCount when building com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo");
    }
    return new SharedConnectionsInfo(localArrayList, i, bool2, bool1);
  }
    ...
    throws IOException
  {
    ...
    if (((ByteBuffer)localObject1).getInt() != -1611377594)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      throw new IOException("Failed to find required field: sharedConnections when reading com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo from fission.");
    }
    if (!bool2) {
      throw new IOException("Failed to find required field: totalCount when reading com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfo from fission.");
    }
    return new SharedConnectionsInfo(paramString, i, bool1, bool2);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.endorsedSkill.SharedConnectionsInfoBuilder
