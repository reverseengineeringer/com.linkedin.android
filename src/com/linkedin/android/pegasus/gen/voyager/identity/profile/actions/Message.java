  ...
  implements FissileDataModel<Message>, RecordTemplate<Message>
{
  ...
  public static Message accept(DataProcessor paramDataProcessor)
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localByteBuffer.putInt(188421689);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.profile.actions.Message
