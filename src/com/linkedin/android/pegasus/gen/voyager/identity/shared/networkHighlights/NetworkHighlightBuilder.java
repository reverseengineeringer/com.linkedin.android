...
public final class NetworkHighlightBuilder
  implements FissileDataModelBuilder<NetworkHighlight>, DataTemplateBuilder<NetworkHighlight>
{
  ...
  public static NetworkHighlight build(DataReader paramDataReader)
    throws DataReaderException
  {
    Object localObject = null;
    NetworkHighlightReason localNetworkHighlightReason = null;
    boolean bool2 = false;
    boolean bool1 = false;
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      ...
      {
        paramDataReader.startField();
        localNetworkHighlightReason = (NetworkHighlightReason)paramDataReader.readEnum(NetworkHighlightReason.Builder.INSTANCE);
        bool1 = true;
      }
      else
      {
    ...
    if (!bool2) {
      throw new DataReaderException("Failed to find required field: detail when building com.linkedin.android.pegasus.gen.voyager.identity.shared.networkHighlights.NetworkHighlight");
    }
    return new NetworkHighlight((NetworkHighlight.Detail)localObject, localNetworkHighlightReason, bool2, bool1);
  }
  
  public static NetworkHighlight readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building NetworkHighlight");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building NetworkHighlight");
    }
    ...
    if (((ByteBuffer)localObject).getInt() != 800897265)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject);
      throw new IOException("UID mismatch. Can't read cached data when building NetworkHighlight");
    }
    paramString = null;
    ...
    if (((ByteBuffer)localObject).get() == 1)
    {
      ...
      if (bool2)
      {
        ...
        if (i == 1)
        {
          ...
          paramString = DetailBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject, null, paramFissionTransaction);
          if (paramString == null) {
            break label371;
          }
          bool1 = true;
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      if (bool2) {
        paramFissionTransaction = NetworkHighlightReason.of(paramFissionAdapter.readUnsignedShort((ByteBuffer)localObject));
      }
    ...
    label383:
    return new NetworkHighlight(paramString, paramFissionTransaction, bool1, bool2);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.shared.networkHighlights.NetworkHighlightBuilder
