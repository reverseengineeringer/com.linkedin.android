...
public final class ActorMiniProfile
  implements FissileDataModel<ActorMiniProfile>, RecordTemplate<ActorMiniProfile>
{
  public static final ActorMiniProfileBuilder BUILDER = ActorMiniProfileBuilder.INSTANCE;
  ...
  ActorMiniProfile(MiniProfile paramMiniProfile, MemberDistance paramMemberDistance, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public final ActorMiniProfile accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.ActorMiniProfile", "miniProfile");
      }
    ...
    label196:
    if (!hasDistance) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.identity.me.ActorMiniProfile", "distance");
    }
    return new ActorMiniProfile((MiniProfile)localObject2, (MemberDistance)localObject1, bool1, bool2);
    label229:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ActorMiniProfile)paramObject;
      if (miniProfile != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building ActorMiniProfile");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1231498478);
        if (hasMiniProfile)
        {
          localByteBuffer.put((byte)1);
          if (miniProfile._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.me.ActorMiniProfile
