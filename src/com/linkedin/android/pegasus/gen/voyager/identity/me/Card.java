...
public final class Card
  implements FissileDataModel<Card>, RecordTemplate<Card>
{
  ...
  Card(Value paramValue, Urn paramUrn1, String paramString, Urn paramUrn2, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    value = paramValue;
    objectUrn = paramUrn1;
    ...
    throws DataProcessorException
  {
    ...
    return new Card(localValue, objectUrn, trackingId, entityUrn, bool, hasObjectUrn, hasTrackingId, hasEntityUrn);
    label297:
    return null;
  }
  ...
  public final int hashCode()
  {
    ...
    label87:
    for (int j = objectUrn.hashCode();; j = 0)
    {
      if (entityUrn != null) {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1077250362);
        if (hasValue)
        {
          localByteBuffer.put((byte)1);
          if (value._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.me.Card
