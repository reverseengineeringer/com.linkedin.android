...
public final class GuidedEditProfileUpdate
  implements FissileDataModel<GuidedEditProfileUpdate>, RecordTemplate<GuidedEditProfileUpdate>
{
  ...
  GuidedEditProfileUpdate(ProfileUpdate paramProfileUpdate, boolean paramBoolean)
  {
    profileUpdate = paramProfileUpdate;
    hasProfileUpdate = paramBoolean;
    _cachedId = null;
  }
  
  private GuidedEditProfileUpdate accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    paramDataProcessor.startRecord();
    ProfileUpdate localProfileUpdate = null;
    boolean bool = false;
    if (hasProfileUpdate)
    {
      paramDataProcessor.startRecordField$505cff1c("profileUpdate");
      if (!paramDataProcessor.shouldAcceptTransitively()) {
        break label93;
      }
      localProfileUpdate = profileUpdate.accept(paramDataProcessor);
      if (localProfileUpdate == null) {
        break label110;
      }
    }
    label93:
    ...
    for (bool = true;; bool = false)
    {
      ...
      localProfileUpdate = (ProfileUpdate)paramDataProcessor.processDataTemplate(profileUpdate);
      break;
    }
    label115:
    return new GuidedEditProfileUpdate(localProfileUpdate, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (GuidedEditProfileUpdate)paramObject;
      if (profileUpdate == null) {
        break;
      }
    } while (profileUpdate.equals(profileUpdate));
    for (;;)
    {
      return false;
      if (profileUpdate == null) {
  ...
  public final int getSerializedSize()
  {
    ...
    int i = 0 + 1 + 4 + 1;
    if (hasProfileUpdate) {
      if (profileUpdate._cachedId == null) {
        break label58;
      }
    }
    label58:
    for (i = PegasusBinaryUtils.getEncodedLength(profileUpdate._cachedId) + 9;; i = profileUpdate.getSerializedSize() + 7)
    {
      __sizeOfObject = i;
      return i;
    }
  ...
  public final int hashCode()
  {
    ...
    if (profileUpdate != null) {}
    for (int i = profileUpdate.hashCode();; i = 0)
    {
      i += 527;
      _cachedHashCode = i;
      return i;
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building GuidedEditProfileUpdate");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(374922249);
        if (hasProfileUpdate)
        {
          localByteBuffer.put((byte)1);
          if (profileUpdate._cachedId != null)
          {
            ...
            paramFissionAdapter.writeString(localByteBuffer, profileUpdate._cachedId);
            profileUpdate.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
          }
        }
        while (paramByteBuffer == null)
        {
          ...
          return;
          localByteBuffer.put((byte)1);
          profileUpdate.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
    ...
    implements FissileDataModel<ProfileUpdate>, UnionTemplate<ProfileUpdate>
  {
    ...
    public ProfileUpdate(NormPosition paramNormPosition, NormEducation paramNormEducation, boolean paramBoolean1, boolean paramBoolean2)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.identity.guidededit.GuidedEditProfileUpdate
