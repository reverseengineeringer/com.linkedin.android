  ...
  implements FissileDataModelBuilder<JobDetails>, DataTemplateBuilder<JobDetails>
{
  ...
  static
  {
    ...
    JSON_KEY_STORE.put("formattedEmploymentStatus");
    JSON_KEY_STORE.put("formattedExperienceLevel");
    JSON_KEY_STORE.put("formattedLocation");
    JSON_KEY_STORE.put("jobState");
    JSON_KEY_STORE.put("listedAt");
    JSON_KEY_STORE.put("closedAt");
    JSON_KEY_STORE.put("companyDetails");
    ...
    JSON_KEY_STORE.put("applyMethod");
    JSON_KEY_STORE.put("views");
    JSON_KEY_STORE.put("formattedIndustries");
    JSON_KEY_STORE.put("formattedJobFunctions");
  }
  
  public static final class ApplyMethodBuilder
  ...
  public static final class CompanyDetailsBuilder
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.jobs.JobDetailsBuilder
