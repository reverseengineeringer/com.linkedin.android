...
public final class JobDescription
  implements FissileDataModel<JobDescription>, RecordTemplate<JobDescription>
{
  public static final JobDescriptionBuilder BUILDER = JobDescriptionBuilder.INSTANCE;
  ...
  JobDescription(String paramString1, String paramString2, String paramString3, String paramString4, List<String> paramList1, List<String> paramList2, long paramLong, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6, boolean paramBoolean7)
  {
    description = paramString1;
    skillsAndExperience = paramString2;
    employmentStatus = paramString3;
    experience = paramString4;
    if (paramList1 == null)
    {
      paramString1 = null;
    ...
    for (paramString1 = null;; paramString1 = Collections.unmodifiableList(paramList2))
    {
      ...
      jobId = paramLong;
      hasDescription = paramBoolean1;
      hasSkillsAndExperience = paramBoolean2;
      hasEmploymentStatus = paramBoolean3;
      hasExperience = paramBoolean4;
      hasJobFunctions = paramBoolean5;
      hasIndustries = paramBoolean6;
      hasJobId = paramBoolean7;
      _cachedId = null;
      return;
  ...
  public final JobDescription accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.entities.job.JobDescription", "description");
      }
    ...
    if (!hasJobId) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.entities.job.JobDescription", "jobId");
    }
    if (jobFunctions != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((String)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.entities.job.JobDescription", "jobFunctions");
        }
      }
    }
    if (industries != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((String)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.entities.job.JobDescription", "industries");
        }
      }
    }
    return new JobDescription(description, skillsAndExperience, employmentStatus, experience, (List)localObject1, (List)localObject2, jobId, hasDescription, hasSkillsAndExperience, hasEmploymentStatus, hasExperience, bool1, bool2, hasJobId);
    label678:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (JobDescription)paramObject;
      if (description != null)
      {
      ...
      {
        if (skillsAndExperience.equals(skillsAndExperience)) {}
      }
      else {
        while (skillsAndExperience != null) {
          return false;
        }
      }
  ...
  public final int getSerializedSize()
  {
    ...
    int i = 0 + 1 + 4 + 1;
    if (hasDescription) {
      i = PegasusBinaryUtils.getEncodedLength(description) + 8;
    }
    int j = i + 1;
    i = j;
    if (hasSkillsAndExperience) {
      i = j + 2 + PegasusBinaryUtils.getEncodedLength(skillsAndExperience);
    }
    j = i + 1;
    i = j;
    if (hasEmploymentStatus) {
  ...
  public final int hashCode()
  {
    ...
    if (description != null)
    {
      ...
      j = skillsAndExperience.hashCode();
      if (employmentStatus == null) {
        break label180;
      }
      k = employmentStatus.hashCode();
      if (experience == null) {
        break label185;
      }
      m = experience.hashCode();
      label76:
      if (jobFunctions == null) {
        break label191;
      }
    ...
    label185:
    label191:
    for (int n = jobFunctions.hashCode();; n = 0)
    {
      if (industries != null) {
        i1 = industries.hashCode();
      }
      i = ((n + (m + (k + (j + (i + 527) * 31) * 31) * 31) * 31) * 31 + i1) * 31 + (int)(jobId ^ jobId >>> 32);
      _cachedHashCode = i;
      return i;
      i = 0;
      break;
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building JobDescription");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1466535364);
        if (hasDescription)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.job.JobDescription
