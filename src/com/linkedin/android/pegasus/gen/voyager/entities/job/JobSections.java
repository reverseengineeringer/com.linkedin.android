...
public final class JobSections
  implements FissileDataModel<JobSections>, RecordTemplate<JobSections>
{
  public static final JobSectionsBuilder BUILDER = JobSectionsBuilder.INSTANCE;
  ...
  public final Section insights;
  
  JobSections(Section paramSection1, Section paramSection2, Section paramSection3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    highlights = paramSection1;
    details = paramSection2;
    insights = paramSection3;
    hasHighlights = paramBoolean1;
    hasDetails = paramBoolean2;
    hasInsights = paramBoolean3;
    _cachedId = null;
  }
  
  public final JobSections accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    else
    {
      ...
      if (hasInsights)
      {
        ...
        localSection1 = insights.accept(paramDataProcessor);
        label146:
        if (localSection1 == null) {
          break label259;
        }
    ...
    for (boolean bool3 = true;; bool3 = false)
    {
      ...
      return new JobSections((Section)localObject, localSection2, localSection1, bool1, bool2, bool3);
      ...
      localSection2 = localSection1;
      break label106;
      localSection1 = (Section)paramDataProcessor.processDataTemplate(insights);
      break label146;
    }
    label265:
    return null;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (JobSections)paramObject;
      if (highlights != null)
      {
  ...
  public final int getSerializedSize()
  {
    ...
    else
    {
      ...
      {
        i = j + 1;
        if (insights._cachedId == null) {
          break label169;
        }
        i = i + 2 + PegasusBinaryUtils.getEncodedLength(insights._cachedId);
      }
    }
    for (;;)
    {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building JobSections");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1455318527);
        if (hasHighlights)
        {
          localByteBuffer.put((byte)1);
          if (highlights._cachedId != null)
          {
            ...
            localByteBuffer.put((byte)0);
            paramFissionAdapter.writeString(localByteBuffer, insights._cachedId);
            insights.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
          }
        }
        for (;;)
        {
          ...
          break label230;
          localByteBuffer.put((byte)1);
          insights.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.job.JobSections
