...
public final class SchoolSectionsBuilder
  implements FissileDataModelBuilder<SchoolSections>, DataTemplateBuilder<SchoolSections>
{
  public static final SchoolSectionsBuilder INSTANCE = new SchoolSectionsBuilder();
  ...
  public static SchoolSections build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    return new SchoolSections((Section)localObject3, (Section)localObject2, (Section)localObject1, bool3, bool2, bool1);
  }
  
  public static SchoolSections readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building SchoolSections");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building SchoolSections");
    }
    ...
    if (((ByteBuffer)localObject3).getInt() != -836283352)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject3);
      throw new IOException("UID mismatch. Can't read cached data when building SchoolSections");
    }
    paramString = null;
    ...
    for (boolean bool4 = true;; bool4 = false)
    {
      ...
      return new SchoolSections(paramString, (Section)localObject1, (Section)localObject2, bool1, bool2, bool4);
      bool2 = false;
      break;
      bool1 = false;
      break label283;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.school.SchoolSectionsBuilder
