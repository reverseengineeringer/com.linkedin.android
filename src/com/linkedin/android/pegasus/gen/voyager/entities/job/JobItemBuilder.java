...
public final class JobItemBuilder
  implements FissileDataModelBuilder<JobItem>, DataTemplateBuilder<JobItem>
{
  ...
  public static JobItem build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool1) {
      throw new DataReaderException("Failed to find required field: itemInfo when building com.linkedin.android.pegasus.gen.voyager.entities.job.JobItem");
    }
    if (!bool2) {
      throw new DataReaderException("Failed to find required field: item when building com.linkedin.android.pegasus.gen.voyager.entities.job.JobItem");
    }
    return new JobItem((ItemInfo)localObject1, (JobItem.Item)localObject2, bool1, bool2);
  }
  
  public static JobItem readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building JobItem");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building JobItem");
    }
    ...
    if (((ByteBuffer)localObject2).getInt() != -870325655)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject2);
      throw new IOException("UID mismatch. Can't read cached data when building JobItem");
    }
    paramString = null;
    ...
    return new JobItem(paramString, (JobItem.Item)localObject1, bool1, bool3);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.job.JobItemBuilder
