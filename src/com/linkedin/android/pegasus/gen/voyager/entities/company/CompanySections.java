...
public final class CompanySections
  implements FissileDataModel<CompanySections>, RecordTemplate<CompanySections>
{
  ...
  CompanySections(Section paramSection1, Section paramSection2, Section paramSection3, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    highlights = paramSection1;
    details = paramSection2;
    careers = paramSection3;
    hasHighlights = paramBoolean1;
    hasDetails = paramBoolean2;
    hasCareers = paramBoolean3;
    _cachedId = null;
  }
  
  public final CompanySections accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    else
    {
      ...
      if (hasCareers)
      {
        paramDataProcessor.startRecordField$505cff1c("careers");
        if (!paramDataProcessor.shouldAcceptTransitively()) {
          break label241;
        }
        localSection1 = careers.accept(paramDataProcessor);
        label146:
        if (localSection1 == null) {
          break label259;
        }
    ...
    for (boolean bool3 = true;; bool3 = false)
    {
      ...
      return new CompanySections((Section)localObject, localSection2, localSection1, bool1, bool2, bool3);
      ...
      localSection2 = localSection1;
      break label106;
      localSection1 = (Section)paramDataProcessor.processDataTemplate(careers);
      break label146;
    }
    label265:
    return null;
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (CompanySections)paramObject;
      if (highlights != null)
      {
  ...
  public final int getSerializedSize()
  {
    ...
    else
    {
      ...
      {
        i = j + 1;
        if (careers._cachedId == null) {
          break label169;
        }
        i = i + 2 + PegasusBinaryUtils.getEncodedLength(careers._cachedId);
      }
    }
    for (;;)
    {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building CompanySections");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1184074103);
        if (hasHighlights)
        {
          localByteBuffer.put((byte)1);
          if (highlights._cachedId != null)
          {
            ...
            localByteBuffer.put((byte)0);
            paramFissionAdapter.writeString(localByteBuffer, careers._cachedId);
            careers.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
          }
        }
        for (;;)
        {
          ...
          break label230;
          localByteBuffer.put((byte)1);
          careers.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.company.CompanySections
