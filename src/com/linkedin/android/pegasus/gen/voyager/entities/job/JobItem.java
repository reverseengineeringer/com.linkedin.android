...
public final class JobItem
  implements FissileDataModel<JobItem>, RecordTemplate<JobItem>
{
  ...
  JobItem(ItemInfo paramItemInfo, Item paramItem, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public final JobItem accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    return new JobItem((ItemInfo)localObject2, (Item)localObject1, bool1, bool2);
    label229:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (JobItem)paramObject;
      if (itemInfo != null)
      {
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-870325655);
        if (hasItemInfo)
        {
          localByteBuffer.put((byte)1);
          if (itemInfo._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.job.JobItem
