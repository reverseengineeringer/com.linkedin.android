...
public final class CompanySectionsBuilder
  implements FissileDataModelBuilder<CompanySections>, DataTemplateBuilder<CompanySections>
{
  public static final CompanySectionsBuilder INSTANCE = new CompanySectionsBuilder();
  ...
  static
  {
    ...
    JSON_KEY_STORE.put("careers");
  }
  
  public static CompanySections build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      ...
      else if (paramDataReader.shouldReadField$11ca93e7("careers", JSON_KEY_STORE))
      {
        paramDataReader.startField();
    ...
    return new CompanySections((Section)localObject3, (Section)localObject2, (Section)localObject1, bool3, bool2, bool1);
  }
  
  public static CompanySections readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building CompanySections");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building CompanySections");
    }
    ...
    if (((ByteBuffer)localObject3).getInt() != 1184074103)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject3);
      throw new IOException("UID mismatch. Can't read cached data when building CompanySections");
    }
    paramString = null;
    ...
    for (boolean bool4 = true;; bool4 = false)
    {
      ...
      return new CompanySections(paramString, (Section)localObject1, (Section)localObject2, bool1, bool2, bool4);
      bool2 = false;
      break;
      bool1 = false;
      break label283;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.company.CompanySectionsBuilder
