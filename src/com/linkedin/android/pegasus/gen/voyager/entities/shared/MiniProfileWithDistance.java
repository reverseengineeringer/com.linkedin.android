...
public final class MiniProfileWithDistance
  implements FissileDataModel<MiniProfileWithDistance>, RecordTemplate<MiniProfileWithDistance>
{
  public static final MiniProfileWithDistanceBuilder BUILDER = MiniProfileWithDistanceBuilder.INSTANCE;
  ...
  MiniProfileWithDistance(MiniProfile paramMiniProfile, MemberDistance paramMemberDistance, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public final MiniProfileWithDistance accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.entities.shared.MiniProfileWithDistance", "miniProfile");
      }
    ...
    label196:
    if (!hasDistance) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.entities.shared.MiniProfileWithDistance", "distance");
    }
    return new MiniProfileWithDistance((MiniProfile)localObject2, (MemberDistance)localObject1, bool1, bool2);
    label229:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (MiniProfileWithDistance)paramObject;
      if (miniProfile != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building MiniProfileWithDistance");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(787161918);
        if (hasMiniProfile)
        {
          localByteBuffer.put((byte)1);
          if (miniProfile._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.shared.MiniProfileWithDistance
