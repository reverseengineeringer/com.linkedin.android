...
public final class MiniProfilesCollection
  implements FissileDataModel<MiniProfilesCollection>, RecordTemplate<MiniProfilesCollection>
{
  public static final MiniProfilesCollectionBuilder BUILDER = MiniProfilesCollectionBuilder.INSTANCE;
  private volatile int __sizeOfObject = -1;
  private volatile int _cachedHashCode = -1;
  public final String _cachedId;
  public final boolean hasItems;
  public final boolean hasPagingInfo;
  public final List<EntitiesMiniProfile> items;
  public final PagingInfo pagingInfo;
  
  MiniProfilesCollection(List<EntitiesMiniProfile> paramList, PagingInfo paramPagingInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramList == null) {}
  ...
  public final MiniProfilesCollection accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasItems)
    {
      ...
      if (localIterator.hasNext())
      {
        ...
        for (localObject2 = ((EntitiesMiniProfile)localObject2).accept(paramDataProcessor);; localObject2 = (EntitiesMiniProfile)paramDataProcessor.processDataTemplate((DataTemplate)localObject2))
        {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.entities.common.MiniProfilesCollection", "items");
      }
    ...
    label307:
    if (!hasPagingInfo) {
      throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.entities.common.MiniProfilesCollection", "pagingInfo");
    }
    if (items != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((EntitiesMiniProfile)paramDataProcessor.next() == null) {
          throw new NullArrayItemException("com.linkedin.android.pegasus.gen.voyager.entities.common.MiniProfilesCollection", "items");
        }
      }
    }
    return new MiniProfilesCollection((List)localObject2, (PagingInfo)localObject1, bool1, bool2);
    label391:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (MiniProfilesCollection)paramObject;
      if (items != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building MiniProfilesCollection");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1766248684);
        if (hasItems)
        {
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.common.MiniProfilesCollection
