...
public final class InCommonPersonCollection
  implements FissileDataModel<InCommonPersonCollection>, RecordTemplate<InCommonPersonCollection>
{
  ...
  InCommonPersonCollection(List<InCommonPerson> paramList, PagingInfo paramPagingInfo, boolean paramBoolean1, boolean paramBoolean2)
  {
    if (paramList == null) {}
  ...
  public final InCommonPersonCollection accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasItems)
    {
      ...
      {
        localObject2 = (InCommonPerson)localIterator.next();
        paramDataProcessor.processArrayItem(i);
        if (paramDataProcessor.shouldAcceptTransitively()) {}
        for (localObject2 = ((InCommonPerson)localObject2).accept(paramDataProcessor);; localObject2 = (InCommonPerson)paramDataProcessor.processDataTemplate((DataTemplate)localObject2))
        {
    ...
    if (items != null)
    {
      ...
      while (paramDataProcessor.hasNext()) {
        if ((InCommonPerson)paramDataProcessor.next() == null) {
    ...
    return new InCommonPersonCollection((List)localObject2, (PagingInfo)localObject1, bool1, bool2);
    label391:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (InCommonPersonCollection)paramObject;
      if (items != null)
      {
  ...
  public final int getSerializedSize()
  {
    ...
    if (hasItems)
    {
      ...
      for (;;)
      {
        ...
        InCommonPerson localInCommonPerson = (InCommonPerson)localIterator.next();
        i += 1;
        if (_cachedId != null) {
          i = i + 2 + PegasusBinaryUtils.getEncodedLength(_cachedId);
        } else {
          i += localInCommonPerson.getSerializedSize();
        }
      }
    }
    j += 1;
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1942063534);
        if (hasItems)
        {
          localByteBuffer.put((byte)1);
          ...
          while (localIterator.hasNext())
          {
            ...
            if (_cachedId != null)
            {
              ...
              localInCommonPerson.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
            }
            else
            {
              localByteBuffer.put((byte)1);
              localInCommonPerson.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
            }
          }
        }
        localByteBuffer.put((byte)0);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.incommon.InCommonPersonCollection
