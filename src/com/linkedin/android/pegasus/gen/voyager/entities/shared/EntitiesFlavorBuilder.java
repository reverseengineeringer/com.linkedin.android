...
public final class EntitiesFlavorBuilder
  implements FissileDataModelBuilder<EntitiesFlavor>, DataTemplateBuilder<EntitiesFlavor>
{
  ...
  public static EntitiesFlavor build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool) {
      throw new DataReaderException("Failed to find required field: reason when building com.linkedin.android.pegasus.gen.voyager.entities.shared.EntitiesFlavor");
    }
    return new EntitiesFlavor((EntitiesFlavor.Reason)localObject, bool);
  }
  
  public static EntitiesFlavor readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building EntitiesFlavor");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building EntitiesFlavor");
    }
    ...
    if (((ByteBuffer)localObject1).getInt() != 833893972)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
      throw new IOException("UID mismatch. Can't read cached data when building EntitiesFlavor");
    }
    paramString = null;
    localObject2 = null;
    boolean bool1;
    if (((ByteBuffer)localObject1).get() == 1)
    {
      ...
      if (bool1)
      {
        ...
        if (i == 0)
        {
          ...
          localObject2 = ReasonBuilder.INSTANCE;
    ...
    label342:
    return new EntitiesFlavor(paramString, bool2);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.shared.EntitiesFlavorBuilder
