...
public final class Section
  implements FissileDataModel<Section>, RecordTemplate<Section>
{
  ...
  Section(int paramInt, List<Items> paramList, boolean paramBoolean1, boolean paramBoolean2)
  {
    rank = paramInt;
    if (paramList == null) {}
    ...
    throws DataProcessorException
  {
    ...
    if (hasItems)
    {
      ...
      {
        localItems = (Items)localIterator.next();
        paramDataProcessor.processArrayItem(i);
        if (paramDataProcessor.shouldAcceptTransitively()) {}
        for (localItems = localItems.accept(paramDataProcessor);; localItems = (Items)paramDataProcessor.processDataTemplate(localItems))
        {
          if ((localObject != null) && (localItems != null)) {
            ((List)localObject).add(localItems);
          }
          i += 1;
          break;
        }
    ...
    if (hasItems)
    {
      ...
      for (;;)
      {
        ...
        if (_cachedId != null) {
          ...
          i += localItems.getSerializedSize();
        }
      }
    }
    __sizeOfObject = j;
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      do
      {
        ...
        localByteBuffer.putInt(-1926940691);
        ...
        else
        {
          for (;;)
          {
            ...
            if (_cachedId != null)
            {
              ...
              localItems.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
              continue;
              localByteBuffer.put((byte)0);
              break;
            }
            localByteBuffer.put((byte)1);
            localItems.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          }
        }
        localByteBuffer.put((byte)0);
    ...
    implements FissileDataModel<Items>, UnionTemplate<Items>
  {
    ...
    Items(CompanyItem paramCompanyItem, ShowcaseItemType paramShowcaseItemType, SchoolItem paramSchoolItem, JobItem paramJobItem, GroupItem paramGroupItem, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.common.Section
