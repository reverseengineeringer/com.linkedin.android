...
public final class EntitiesFlavor
  implements FissileDataModel<EntitiesFlavor>, RecordTemplate<EntitiesFlavor>
{
  ...
  EntitiesFlavor(Reason paramReason, boolean paramBoolean)
  {
    reason = paramReason;
  ...
  public final EntitiesFlavor accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    label115:
    return new EntitiesFlavor(localReason, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (EntitiesFlavor)paramObject;
      if (reason == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building EntitiesFlavor");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(833893972);
        if (hasReason)
        {
          localByteBuffer.put((byte)1);
          if (reason._cachedId != null)
    ...
    implements FissileDataModel<Reason>, UnionTemplate<Reason>
  {
    ...
    Reason(InNetworkReason paramInNetworkReason, CompanyRecruitReason paramCompanyRecruitReason, SchoolRecruitReason paramSchoolRecruitReason, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.shared.EntitiesFlavor
