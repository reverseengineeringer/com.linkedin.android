...
public final class CompanyItemBuilder
  implements FissileDataModelBuilder<CompanyItem>, DataTemplateBuilder<CompanyItem>
{
  ...
  public static CompanyItem build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    return new CompanyItem((ItemInfo)localObject1, (CompanyItem.Item)localObject2, bool1, bool2);
  }
  
  public static CompanyItem readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    ...
    if (((ByteBuffer)localObject2).getInt() != -1590279436)
    {
    ...
    return new CompanyItem(paramString, (CompanyItem.Item)localObject1, bool1, bool3);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.entities.company.CompanyItemBuilder
