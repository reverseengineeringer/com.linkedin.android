...
public final class PropDetail
  implements FissileDataModel<PropDetail>, RecordTemplate<PropDetail>
{
  ...
  PropDetail(Detail paramDetail, boolean paramBoolean)
  {
    detail = paramDetail;
    hasDetail = paramBoolean;
    _cachedId = null;
  }
  
  public final PropDetail accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    label115:
    return new PropDetail(localDetail, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (PropDetail)paramObject;
      if (detail == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building PropDetail");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-450255470);
        if (hasDetail)
        {
          localByteBuffer.put((byte)1);
          if (detail._cachedId != null)
    ...
    implements FissileDataModel<Detail>, UnionTemplate<Detail>
  {
    ...
    Detail(InvitationInfo paramInvitationInfo, LegoTrackingInfo paramLegoTrackingInfo, MeetingInfo paramMeetingInfo, SocialDetailInfo paramSocialDetailInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.relationships.shared.prop.PropDetail
