...
public final class Annotation
  implements FissileDataModel<Annotation>, RecordTemplate<Annotation>
{
  ...
  Annotation(int paramInt1, int paramInt2, Attribute paramAttribute, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    start = paramInt1;
    end = paramInt2;
    ...
    hasAttribute = paramBoolean3;
    _cachedId = null;
  }
  
  public final Annotation accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasAttribute)
    {
      ...
      localAttribute = attribute.accept(paramDataProcessor);
    ...
    for (bool = true;; bool = false)
    {
      ...
      localAttribute = (Attribute)paramDataProcessor.processDataTemplate(attribute);
      break;
    }
    label165:
    if (!hasEnd) {
    ...
    return new Annotation(start, end, localAttribute, hasStart, hasEnd, bool);
    label229:
    return null;
  }
  ...
  public final int getSerializedSize()
  {
    ...
    {
      i = j + 1;
      if (attribute._cachedId == null) {
        break label99;
      }
      i = i + 2 + PegasusBinaryUtils.getEncodedLength(attribute._cachedId);
    }
    for (;;)
    {
      __sizeOfObject = i;
  ...
  public final int hashCode()
  {
    ...
    int k = end;
    if (attribute != null) {}
    for (int i = attribute.hashCode();; i = 0)
    {
      i = ((j + 527) * 31 + k) * 31 + i;
      _cachedHashCode = i;
      return i;
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(851453633);
        if (hasStart)
        {
          localByteBuffer.put((byte)1);
          ...
          paramFissionAdapter.writeString(localByteBuffer, attribute._cachedId);
          attribute.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
        }
        for (;;)
        {
          if (paramByteBuffer != null) {
          ...
          break label158;
          localByteBuffer.put((byte)1);
          attribute.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
    ...
    implements FissileDataModel<Attribute>, UnionTemplate<Attribute>
  {
    ...
    Attribute(Format paramFormat, ExternalLink paramExternalLink, MiniProfile paramMiniProfile, MiniCompany paramMiniCompany, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.relationships.shared.annotation.Annotation
