...
public final class ConnectionsSummary
  implements FissileDataModel<ConnectionsSummary>, RecordTemplate<ConnectionsSummary>
{
  ...
  ConnectionsSummary(Urn paramUrn, int paramInt, boolean paramBoolean1, boolean paramBoolean2)
  {
    entityUrn = paramUrn;
  ...
  private ConnectionsSummary accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (paramDataProcessor.shouldReturnProcessedTemplate())
    {
      ...
      return new ConnectionsSummary(entityUrn, numConnections, hasEntityUrn, hasNumConnections);
    }
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ConnectionsSummary)paramObject;
      if (entityUrn != null)
      {
    ...
    } while (numConnections == numConnections);
    return false;
  }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building ConnectionsSummary");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(537669836);
        if (hasEntityUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.relationships.shared.connection.ConnectionsSummary
