...
public final class ProfileInvitee
  implements FissileDataModel<ProfileInvitee>, RecordTemplate<ProfileInvitee>
{
  public static final ProfileInviteeBuilder BUILDER = ProfileInviteeBuilder.INSTANCE;
  ...
  ProfileInvitee(MiniProfile paramMiniProfile, boolean paramBoolean)
  {
  ...
  public final ProfileInvitee accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.relationships.invitation.ProfileInvitee", "miniProfile");
      }
    ...
    label115:
    return new ProfileInvitee(localMiniProfile, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ProfileInvitee)paramObject;
      if (miniProfile == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building ProfileInvitee");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1383389858);
        if (hasMiniProfile)
        {
          localByteBuffer.put((byte)1);
          if (miniProfile._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.relationships.invitation.ProfileInvitee
