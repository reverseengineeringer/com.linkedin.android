  ...
  implements FissileDataModel<Insight>, RecordTemplate<Insight>
{
  ...
  Insight(SharedInsight paramSharedInsight, boolean paramBoolean)
  {
    sharedInsight = paramSharedInsight;
    hasSharedInsight = paramBoolean;
    _cachedId = null;
  }
    ...
    throws DataProcessorException
  {
    ...
    SharedInsight localSharedInsight = null;
    boolean bool = false;
    if (hasSharedInsight)
    {
      paramDataProcessor.startRecordField$505cff1c("sharedInsight");
      if (!paramDataProcessor.shouldAcceptTransitively()) {
        break label93;
      }
      localSharedInsight = sharedInsight.accept(paramDataProcessor);
      if (localSharedInsight == null) {
        break label110;
      }
    }
    label93:
    ...
    for (bool = true;; bool = false)
    {
      ...
      localSharedInsight = (SharedInsight)paramDataProcessor.processDataTemplate(sharedInsight);
      break;
    }
    label115:
    return new Insight(localSharedInsight, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while (sharedInsight.equals(sharedInsight));
    for (;;)
    {
      return false;
      if (sharedInsight == null) {
  ...
  public final int getSerializedSize()
  {
    ...
    int i = 0 + 1 + 4 + 1;
    if (hasSharedInsight) {
      if (sharedInsight._cachedId == null) {
        break label58;
      }
    }
    label58:
    for (i = PegasusBinaryUtils.getEncodedLength(sharedInsight._cachedId) + 9;; i = sharedInsight.getSerializedSize() + 7)
    {
      __sizeOfObject = i;
      return i;
    }
  ...
  public final int hashCode()
  {
    ...
    if (sharedInsight != null) {}
    for (int i = sharedInsight.hashCode();; i = 0)
    {
      i += 527;
      _cachedHashCode = i;
      return i;
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-2117847196);
        if (hasSharedInsight)
        {
          localByteBuffer.put((byte)1);
          if (sharedInsight._cachedId != null)
          {
            ...
            paramFissionAdapter.writeString(localByteBuffer, sharedInsight._cachedId);
            sharedInsight.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
          }
        }
        while (paramByteBuffer == null)
        {
          ...
          return;
          localByteBuffer.put((byte)1);
          sharedInsight.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
  ...
  public static final class SharedInsight
    implements FissileDataModel<SharedInsight>, UnionTemplate<SharedInsight>
  {
    ...
    SharedInsight(SharedCompanyInsight paramSharedCompanyInsight, SharedConnectionsInsight paramSharedConnectionsInsight, SharedEducationInsight paramSharedEducationInsight, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.relationships.shared.Insight
