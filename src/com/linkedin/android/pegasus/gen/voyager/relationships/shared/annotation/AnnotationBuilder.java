...
public final class AnnotationBuilder
  implements FissileDataModelBuilder<Annotation>, DataTemplateBuilder<Annotation>
{
  ...
  public static Annotation build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      ...
      {
        paramDataReader.startField();
        localObject = AttributeBuilder.INSTANCE;
        localObject = AttributeBuilder.build(paramDataReader);
        bool1 = true;
      }
      else
      {
    ...
    return new Annotation(j, i, (Annotation.Attribute)localObject, bool3, bool2, bool1);
  }
  
  public static Annotation readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    ...
    if (((ByteBuffer)localObject1).getInt() != 851453633)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
    ...
    return new Annotation(i, j, paramString, bool3, bool4, bool2);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.relationships.shared.annotation.AnnotationBuilder
