  ...
  implements FissileDataModelBuilder<DateRange>, DataTemplateBuilder<DateRange>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("startDate");
    ...
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("startDate", JSON_KEY_STORE))
      {
    ...
    throws IOException
  {
    ...
    if (((ByteBuffer)localObject2).getInt() != 1385617250)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.common.DateRangeBuilder
