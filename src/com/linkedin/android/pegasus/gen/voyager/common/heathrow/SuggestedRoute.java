...
public final class SuggestedRoute
  implements FissileDataModel<SuggestedRoute>, RecordTemplate<SuggestedRoute>
{
  ...
  SuggestedRoute(Route paramRoute, boolean paramBoolean)
  {
    route = paramRoute;
    hasRoute = paramBoolean;
    _cachedId = null;
  }
  
  private SuggestedRoute accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasRoute)
    {
      paramDataProcessor.startRecordField$505cff1c("route");
      if (!paramDataProcessor.shouldAcceptTransitively()) {
        break label93;
      }
      localRoute = route.accept(paramDataProcessor);
      if (localRoute == null) {
        break label110;
      }
    }
    ...
    for (bool = true;; bool = false)
    {
      ...
      localRoute = (Route)paramDataProcessor.processDataTemplate(route);
      break;
    }
    label115:
    return new SuggestedRoute(localRoute, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (SuggestedRoute)paramObject;
      if (route == null) {
        break;
      }
    } while (route.equals(route));
    for (;;)
    {
      return false;
      if (route == null) {
  ...
  public final int getSerializedSize()
  {
    ...
    int i = 0 + 1 + 4 + 1;
    if (hasRoute) {
      if (route._cachedId == null) {
        break label58;
      }
    }
    label58:
    for (i = PegasusBinaryUtils.getEncodedLength(route._cachedId) + 9;; i = route.getSerializedSize() + 7)
    {
      __sizeOfObject = i;
      return i;
    }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building SuggestedRoute");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1757497064);
        if (hasRoute)
        {
          localByteBuffer.put((byte)1);
          if (route._cachedId != null)
          {
            ...
            paramFissionAdapter.writeString(localByteBuffer, route._cachedId);
            route.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
          }
        }
        while (paramByteBuffer == null)
        {
          ...
          return;
          localByteBuffer.put((byte)1);
          route.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
    ...
    implements FissileDataModel<Route>, UnionTemplate<Route>
  {
    ...
    Route(AbiRoute paramAbiRoute, PymkRoute paramPymkRoute, FeedRoute paramFeedRoute, FallbackRoute paramFallbackRoute, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.common.heathrow.SuggestedRoute
