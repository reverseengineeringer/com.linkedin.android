...
public final class ParticipantReceipts
  implements FissileDataModel<ParticipantReceipts>, RecordTemplate<ParticipantReceipts>
{
  public static final ParticipantReceiptsBuilder BUILDER = ParticipantReceiptsBuilder.INSTANCE;
  ...
  ParticipantReceipts(MessagingProfileEntity paramMessagingProfileEntity, SeenReceipt paramSeenReceipt, boolean paramBoolean1, boolean paramBoolean2)
  {
  ...
  public final ParticipantReceipts accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.messaging.ParticipantReceipts", "fromParticipant");
      }
    ...
    label196:
    return new ParticipantReceipts((MessagingProfileEntity)localObject2, (SeenReceipt)localObject1, bool1, bool2);
    label210:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ParticipantReceipts)paramObject;
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building ParticipantReceipts");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(757997545);
        if (hasFromParticipant)
        {
          localByteBuffer.put((byte)1);
          if (fromParticipant._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.messaging.ParticipantReceipts
