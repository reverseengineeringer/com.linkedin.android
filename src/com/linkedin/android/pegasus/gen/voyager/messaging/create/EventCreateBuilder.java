...
public final class EventCreateBuilder
  implements FissileDataModelBuilder<EventCreate>, DataTemplateBuilder<EventCreate>
{
  ...
  public static EventCreate build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool) {
      throw new DataReaderException("Failed to find required field: value when building com.linkedin.android.pegasus.gen.voyager.messaging.create.EventCreate");
    }
    return new EventCreate((EventCreate.Value)localObject, bool);
  }
  
  public static EventCreate readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building EventCreate");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building EventCreate");
    }
    ...
    if (((ByteBuffer)localObject1).getInt() != 548192314)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
      throw new IOException("UID mismatch. Can't read cached data when building EventCreate");
    }
    paramString = null;
    localObject2 = null;
    boolean bool1;
    ...
    label342:
    return new EventCreate(paramString, bool2);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.messaging.create.EventCreateBuilder
