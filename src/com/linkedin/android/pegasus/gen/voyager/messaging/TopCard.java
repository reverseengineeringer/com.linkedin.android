...
public final class TopCard
  implements FissileDataModel<TopCard>, RecordTemplate<TopCard>
{
  ...
  TopCard(Value paramValue, boolean paramBoolean)
  {
    value = paramValue;
  ...
  private TopCard accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.messaging.TopCard", "value");
      }
    ...
    label115:
    return new TopCard(localValue, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (TopCard)paramObject;
      if (value == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building TopCard");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-234535921);
        if (hasValue)
        {
          localByteBuffer.put((byte)1);
          if (value._cachedId != null)
    ...
    implements FissileDataModel<Value>, UnionTemplate<Value>
  {
    ...
    Value(MemberTopCard paramMemberTopCard, CompanyTopCard paramCompanyTopCard, boolean paramBoolean1, boolean paramBoolean2)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.messaging.TopCard
