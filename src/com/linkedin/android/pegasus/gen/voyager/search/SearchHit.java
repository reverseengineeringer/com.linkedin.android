...
public final class SearchHit
  implements FissileDataModel<SearchHit>, RecordTemplate<SearchHit>
{
  ...
  SearchHit(HitInfo paramHitInfo, boolean paramBoolean)
  {
  ...
  public final SearchHit accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    label115:
    return new SearchHit(localHitInfo, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (SearchHit)paramObject;
      if (hitInfo == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1867824980);
        if (hasHitInfo)
        {
          localByteBuffer.put((byte)1);
          if (hitInfo._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.search.SearchHit
