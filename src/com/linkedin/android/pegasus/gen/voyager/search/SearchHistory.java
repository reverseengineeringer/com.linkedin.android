...
public final class SearchHistory
  implements FissileDataModel<SearchHistory>, RecordTemplate<SearchHistory>
{
  ...
  SearchHistory(String paramString1, String paramString2, SearchType paramSearchType, HistoryInfo paramHistoryInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4)
  {
    ...
    hasSearchType = paramBoolean3;
    hasHistoryInfo = paramBoolean4;
    _cachedId = null;
  }
  
  private SearchHistory accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasSearchType)
    {
      paramDataProcessor.startRecordField$505cff1c("searchType");
      paramDataProcessor.processEnum(searchType);
    }
    HistoryInfo localHistoryInfo = null;
    boolean bool = false;
    if (hasHistoryInfo)
    {
      paramDataProcessor.startRecordField$505cff1c("historyInfo");
      if (!paramDataProcessor.shouldAcceptTransitively()) {
        break label168;
      }
      localHistoryInfo = historyInfo.accept(paramDataProcessor);
    ...
    for (bool = true;; bool = false)
    {
      ...
      localHistoryInfo = (HistoryInfo)paramDataProcessor.processDataTemplate(historyInfo);
      break;
    }
    label190:
    if (!hasSearchType) {
    ...
    return new SearchHistory(displayText, subtext, searchType, localHistoryInfo, hasDisplayText, hasSubtext, hasSearchType, bool);
    label262:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    } while (historyInfo.equals(historyInfo));
    for (;;)
    {
      return false;
      if (historyInfo == null) {
  ...
  public final int getSerializedSize()
  {
    ...
    int i = 0 + 1 + 4 + 1;
    if (hasDisplayText) {
      i = PegasusBinaryUtils.getEncodedLength(displayText) + 8;
    }
    int j = i + 1;
    i = j;
    if (hasSubtext) {
    ...
    {
      i = j + 1;
      if (historyInfo._cachedId == null) {
        break label129;
      }
      i = i + 2 + PegasusBinaryUtils.getEncodedLength(historyInfo._cachedId);
    }
    for (;;)
    {
      __sizeOfObject = i;
      return i;
      label129:
      i += historyInfo.getSerializedSize();
    }
  }
  ...
  public final int hashCode()
  {
    ...
    label110:
    label115:
    for (int k = searchType.hashCode();; k = 0)
    {
      if (historyInfo != null) {
        m = historyInfo.hashCode();
      }
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(1867583949);
        if (hasDisplayText)
        {
          localByteBuffer.put((byte)1);
          ...
          localByteBuffer.put((byte)1);
          paramFissionAdapter.writeUnsignedShort(localByteBuffer, searchType.ordinal());
          if (!hasHistoryInfo) {
            break label339;
          }
          localByteBuffer.put((byte)1);
          ...
          paramFissionAdapter.writeString(localByteBuffer, historyInfo._cachedId);
          historyInfo.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
        }
        for (;;)
        {
          if (paramByteBuffer != null) {
          ...
          break label191;
          localByteBuffer.put((byte)1);
          historyInfo.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.search.SearchHistory
