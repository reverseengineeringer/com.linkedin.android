...
public final class SearchHitBuilder
  implements FissileDataModelBuilder<SearchHit>, DataTemplateBuilder<SearchHit>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("hitInfo");
  }
  
  public static SearchHit build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("hitInfo", JSON_KEY_STORE))
      {
        paramDataReader.startField();
        localObject = HitInfoBuilder.INSTANCE;
        localObject = HitInfoBuilder.build(paramDataReader);
        bool = true;
      }
      else
      {
    ...
    if (!bool) {
      throw new DataReaderException("Failed to find required field: hitInfo when building com.linkedin.android.pegasus.gen.voyager.search.SearchHit");
    }
    return new SearchHit((SearchHit.HitInfo)localObject, bool);
  }
  
  public static SearchHit readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building SearchHit");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building SearchHit");
    }
    ...
    if (((ByteBuffer)localObject1).getInt() != 1867824980)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
      throw new IOException("UID mismatch. Can't read cached data when building SearchHit");
    }
    paramString = null;
    localObject2 = null;
    boolean bool1;
    if (((ByteBuffer)localObject1).get() == 1)
    {
      ...
      if (bool1)
      {
        ...
        if (i == 0)
        {
          ...
          localObject2 = HitInfoBuilder.INSTANCE;
          paramString = HitInfoBuilder.readFromFission(paramFissionAdapter, null, paramString, paramFissionTransaction);
          if (paramString == null) {
            break label330;
          }
          bool1 = true;
        ...
        if (i == 1)
        {
          paramString = HitInfoBuilder.INSTANCE;
          paramString = HitInfoBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject1, null, paramFissionTransaction);
          if (paramString == null) {
            break label336;
          }
        }
    ...
    for (boolean bool2 = true;; bool2 = false)
    {
      ...
      throw new IOException("Failed to find required field: hitInfo when reading com.linkedin.android.pegasus.gen.voyager.search.SearchHit from fission.");
      bool1 = false;
      break;
      bool1 = false;
      break label267;
    ...
    label342:
    return new SearchHit(paramString, bool2);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.search.SearchHitBuilder
