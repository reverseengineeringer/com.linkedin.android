...
public final class PremiumOnboardingCard
  implements FissileDataModel<PremiumOnboardingCard>, RecordTemplate<PremiumOnboardingCard>
{
  ...
  PremiumOnboardingCard(Card paramCard, boolean paramBoolean)
  {
    card = paramCard;
    hasCard = paramBoolean;
    _cachedId = null;
  }
  
  private PremiumOnboardingCard accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasCard)
    {
      paramDataProcessor.startRecordField$505cff1c("card");
      if (!paramDataProcessor.shouldAcceptTransitively()) {
        break label93;
      }
      localCard = card.accept(paramDataProcessor);
      if (localCard == null) {
        break label110;
      }
    }
    ...
    for (bool = true;; bool = false)
    {
      ...
      localCard = (Card)paramDataProcessor.processDataTemplate(card);
      break;
    }
    label115:
    return new PremiumOnboardingCard(localCard, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (PremiumOnboardingCard)paramObject;
      if (card == null) {
        break;
      }
    } while (card.equals(card));
    for (;;)
    {
      return false;
      if (card == null) {
  ...
  public final int getSerializedSize()
  {
    ...
    label58:
    for (i = PegasusBinaryUtils.getEncodedLength(card._cachedId) + 9;; i = card.getSerializedSize() + 7)
    {
      __sizeOfObject = i;
      return i;
    }
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1116099995);
        if (hasCard)
        {
          localByteBuffer.put((byte)1);
          if (card._cachedId != null)
          {
            ...
            paramFissionAdapter.writeString(localByteBuffer, card._cachedId);
            card.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
          }
        }
        while (paramByteBuffer == null)
        {
          ...
          return;
          localByteBuffer.put((byte)1);
          card.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
          continue;
          localByteBuffer.put((byte)0);
        }
      }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.premium.onboarding.PremiumOnboardingCard
