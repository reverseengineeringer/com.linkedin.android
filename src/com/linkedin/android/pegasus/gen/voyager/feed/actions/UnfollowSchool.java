...
public final class UnfollowSchool
  implements FissileDataModel<UnfollowSchool>, RecordTemplate<UnfollowSchool>
{
  public static final UnfollowSchoolBuilder BUILDER = UnfollowSchoolBuilder.INSTANCE;
  ...
  UnfollowSchool(Urn paramUrn, String paramString, FollowingInfo paramFollowingInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    schoolUrn = paramUrn;
    displayName = paramString;
    followingInfo = paramFollowingInfo;
    hasSchoolUrn = paramBoolean1;
    hasDisplayName = paramBoolean2;
    hasFollowingInfo = paramBoolean3;
    _cachedId = null;
  }
  
  public final UnfollowSchool accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.feed.actions.UnfollowSchool", "schoolUrn");
      }
    ...
    label172:
    return new UnfollowSchool(schoolUrn, displayName, (FollowingInfo)localObject, hasSchoolUrn, hasDisplayName, bool);
    label198:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (UnfollowSchool)paramObject;
      if (schoolUrn != null)
      {
  ...
  public final int getSerializedSize()
  {
    ...
    if (hasSchoolUrn)
    {
      ...
      i = PegasusBinaryUtils.getEncodedLength(UrnCoercer.coerceFromCustomType(schoolUrn)) + 8;
    }
    int j = i + 1;
    i = j;
    if (hasDisplayName) {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building UnfollowSchool");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-221677937);
        if (hasSchoolUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.actions.UnfollowSchool
