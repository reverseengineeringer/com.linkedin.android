...
public final class Likes
  implements FissileDataModel<Likes>, RecordTemplate<Likes>
{
  ...
  Likes(List<Like> paramList, CollectionMetadata paramCollectionMetadata, Metadata paramMetadata, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    if (paramList == null) {}
  ...
  public final Likes accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    if (hasElements)
    {
      ...
      {
        localObject2 = (Like)((Iterator)localObject3).next();
        paramDataProcessor.processArrayItem(i);
        if (paramDataProcessor.shouldAcceptTransitively()) {}
        for (localObject2 = ((Like)localObject2).accept(paramDataProcessor);; localObject2 = (Like)paramDataProcessor.processDataTemplate((DataTemplate)localObject2))
        {
    ...
    return new Likes((List)localObject2, (CollectionMetadata)localObject3, (Metadata)localObject1, bool1, bool2, bool3);
    label475:
    return null;
  }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building Likes");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-705392686);
        if (hasElements)
        {
          localByteBuffer.put((byte)1);
          ...
          while (localIterator.hasNext())
          {
            ...
            if (_cachedId != null)
            {
              ...
              localLike.writeToFission(paramFissionAdapter, null, null, paramBoolean, paramFissionTransaction);
            }
            else
            {
              localByteBuffer.put((byte)1);
              localLike.writeToFission(paramFissionAdapter, localByteBuffer, null, paramBoolean, paramFissionTransaction);
            }
          }
        }
        localByteBuffer.put((byte)0);
    ...
    implements RecordTemplateBuilder<Likes>
  {
    ...
    public Builder(Likes paramLikes)
    {
      elements = elements;
      paging = paging;
      metadata = metadata;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.Likes
