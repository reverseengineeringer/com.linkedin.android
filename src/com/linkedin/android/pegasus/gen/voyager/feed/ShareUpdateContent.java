...
public final class ShareUpdateContent
  implements FissileDataModel<ShareUpdateContent>, RecordTemplate<ShareUpdateContent>
{
  ...
  ShareUpdateContent(Content paramContent, boolean paramBoolean)
  {
  ...
  private ShareUpdateContent accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.feed.ShareUpdateContent", "content");
      }
    ...
    label115:
    return new ShareUpdateContent(localContent, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (ShareUpdateContent)paramObject;
      if (content == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1424296637);
        if (hasContent)
        {
          localByteBuffer.put((byte)1);
          if (content._cachedId != null)
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.ShareUpdateContent
