...
public final class UnfollowCompany
  implements FissileDataModel<UnfollowCompany>, RecordTemplate<UnfollowCompany>
{
  public static final UnfollowCompanyBuilder BUILDER = UnfollowCompanyBuilder.INSTANCE;
  ...
  UnfollowCompany(Urn paramUrn, String paramString, FollowingInfo paramFollowingInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    companyUrn = paramUrn;
    displayName = paramString;
    followingInfo = paramFollowingInfo;
    hasCompanyUrn = paramBoolean1;
    hasDisplayName = paramBoolean2;
    hasFollowingInfo = paramBoolean3;
    _cachedId = null;
  }
  
  public final UnfollowCompany accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.feed.actions.UnfollowCompany", "companyUrn");
      }
    ...
    label172:
    return new UnfollowCompany(companyUrn, displayName, (FollowingInfo)localObject, hasCompanyUrn, hasDisplayName, bool);
    label198:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (UnfollowCompany)paramObject;
      if (companyUrn != null)
      {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building UnfollowCompany");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1879799838);
        if (hasCompanyUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.actions.UnfollowCompany
