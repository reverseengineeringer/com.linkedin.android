...
public final class ShareTextBuilder
  implements FissileDataModelBuilder<ShareText>, DataTemplateBuilder<ShareText>
{
  public static final ShareTextBuilder INSTANCE = new ShareTextBuilder();
  ...
  public static ShareText build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool1) {
      throw new DataReaderException("Failed to find required field: text when building com.linkedin.android.pegasus.gen.voyager.feed.ShareText");
    }
    return new ShareText((AnnotatedText)localObject1, (AttributedText)localObject2, bool1, bool2);
  }
  
  public static ShareText readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building ShareText");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building ShareText");
    }
    ...
    if (((ByteBuffer)localObject2).getInt() != 1626512661)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject2);
      throw new IOException("UID mismatch. Can't read cached data when building ShareText");
    }
    paramString = null;
    ...
    for (boolean bool3 = true;; bool3 = false)
    {
      ...
      throw new IOException("Failed to find required field: text when reading com.linkedin.android.pegasus.gen.voyager.feed.ShareText from fission.");
      bool2 = false;
      break;
      bool1 = false;
      break label277;
    ...
    label469:
    return new ShareText(paramString, (AttributedText)localObject1, bool1, bool3);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.ShareTextBuilder
