  ...
  implements FissileDataModelBuilder<AnnotatedText>, DataTemplateBuilder<AnnotatedText>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("values");
  }
    ...
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("values", JSON_KEY_STORE))
      {
        ...
        if (paramDataReader.isStartOfArray()) {
          ...
          {
            AnnotatedStringBuilder localAnnotatedStringBuilder = AnnotatedStringBuilder.INSTANCE;
            ((List)localObject).add(AnnotatedStringBuilder.build(paramDataReader));
          }
        }
        bool = true;
      }
    ...
    throws IOException
  {
    ...
    if (((ByteBuffer)localObject1).getInt() != 2043626362)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
    ...
    if (((ByteBuffer)localObject1).get() == 1)
    {
      ...
      if (k == 0)
      {
        ...
        AnnotatedStringBuilder localAnnotatedStringBuilder = AnnotatedStringBuilder.INSTANCE;
        paramString = AnnotatedStringBuilder.readFromFission(paramFissionAdapter, null, paramString, paramFissionTransaction);
        if (paramString == null) {
          break label344;
        }
        i = 1;
      ...
      if (k == 1)
      {
        paramString = AnnotatedStringBuilder.INSTANCE;
        paramString = AnnotatedStringBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject1, null, paramFissionTransaction);
        if (paramString == null) {
          break label350;
        }
      }
    ...
    return new AnnotatedText(paramString, bool);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.shared.AnnotatedTextBuilder
