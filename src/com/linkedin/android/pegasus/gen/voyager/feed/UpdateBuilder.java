...
public final class UpdateBuilder
  implements FissileDataModelBuilder<Update>, DataTemplateBuilder<Update>
{
  ...
  static
  {
    ...
    localHashStringKeyStore.put("socialDetail");
    ...
    JSON_KEY_STORE.put("highlightedLikes");
    JSON_KEY_STORE.put("highlightedComments");
    JSON_KEY_STORE.put("permalink");
  }
  
  public static Update build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    while (paramDataReader.hasMoreFields$255f299()) {
      if (paramDataReader.shouldReadField$11ca93e7("socialDetail", JSON_KEY_STORE))
      {
        paramDataReader.startField();
        localObject8 = SocialDetailBuilder.INSTANCE;
        localObject8 = SocialDetailBuilder.build(paramDataReader);
        bool12 = true;
      }
      else if (paramDataReader.shouldReadField$11ca93e7("insight", JSON_KEY_STORE))
      {
        paramDataReader.startField();
        localObject7 = AnnotatedTextBuilder.INSTANCE;
        localObject7 = AnnotatedTextBuilder.build(paramDataReader);
        bool11 = true;
      }
      else if (paramDataReader.shouldReadField$11ca93e7("value", JSON_KEY_STORE))
      {
        paramDataReader.startField();
        localObject6 = ValueBuilder.INSTANCE;
        localObject6 = ValueBuilder.build(paramDataReader);
        bool10 = true;
      }
      ...
      else if (paramDataReader.shouldReadField$11ca93e7("tracking", JSON_KEY_STORE))
      {
        ...
        localObject3 = TrackingDataBuilder.build(paramDataReader);
        bool5 = true;
      }
      ...
      {
        Object localObject9;
        if (paramDataReader.shouldReadField$11ca93e7("highlightedLikes", JSON_KEY_STORE))
        {
          paramDataReader.startField();
          ...
          if (paramDataReader.isStartOfArray()) {
            ...
            {
              localObject9 = LikeBuilder.INSTANCE;
              ((List)localObject2).add(LikeBuilder.build(paramDataReader));
            }
          }
          bool3 = true;
        }
        else if (paramDataReader.shouldReadField$11ca93e7("highlightedComments", JSON_KEY_STORE))
        {
          paramDataReader.startField();
          ...
          if (paramDataReader.isStartOfArray()) {
            while (paramDataReader.hasMoreArrayElements$255f299())
            {
              localObject9 = CommentBuilder.INSTANCE;
              ((List)localObject1).add(CommentBuilder.build(paramDataReader));
            }
          }
          bool2 = true;
        }
    ...
    if (!bool10) {
      throw new DataReaderException("Failed to find required field: value when building com.linkedin.android.pegasus.gen.voyager.feed.Update");
    }
    if (!bool7) {
      throw new DataReaderException("Failed to find required field: isSponsored when building com.linkedin.android.pegasus.gen.voyager.feed.Update");
    }
    return new Update((SocialDetail)localObject8, (AnnotatedText)localObject7, (Update.Value)localObject6, str3, (Urn)localObject5, (Urn)localObject4, bool13, (TrackingData)localObject3, str2, (List)localObject2, (List)localObject1, str1, bool12, bool11, bool10, bool9, bool8, bool6, bool7, bool5, bool4, bool3, bool2, bool1);
  }
  
  public static Update readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building Update");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building Update");
    }
    ...
    if (((ByteBuffer)localObject6).getInt() != -44005164)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject6);
      throw new IOException("UID mismatch. Can't read cached data when building Update");
    }
    paramString = null;
    ...
    if (((ByteBuffer)localObject6).get() == 1)
    {
      ...
      if (bool2)
      {
        ...
        paramString = localSocialDetailBuilder;
        bool1 = bool2;
        if (i == 0)
        {
          paramString = paramFissionAdapter.readString((ByteBuffer)localObject6);
          localSocialDetailBuilder = SocialDetailBuilder.INSTANCE;
          paramString = SocialDetailBuilder.readFromFission(paramFissionAdapter, null, paramString, paramFissionTransaction);
          if (paramString == null) {
            break label956;
          }
          bool1 = true;
        ...
        if (i == 1)
        {
          paramString = SocialDetailBuilder.INSTANCE;
          paramString = SocialDetailBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject6, null, paramFissionTransaction);
          if (paramString == null) {
            break label962;
          }
          bool1 = true;
      ...
      if (bool4)
      {
        ...
        if (i == 0)
        {
          ...
          localObject11 = ValueBuilder.INSTANCE;
          localObject2 = ValueBuilder.readFromFission(paramFissionAdapter, null, (String)localObject2, paramFissionTransaction);
        ...
        if (i == 1)
        {
          ...
          localObject2 = ValueBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject6, null, paramFissionTransaction);
          if (localObject2 == null) {
            break label998;
          }
          bool3 = true;
      ...
      if (bool5)
      {
        ...
        if (i == 0)
        {
          ...
          localObject10 = TrackingDataBuilder.INSTANCE;
        ...
        {
          localObject3 = TrackingDataBuilder.INSTANCE;
          localObject3 = TrackingDataBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject6, null, paramFissionTransaction);
          if (localObject3 == null) {
            break label1046;
          }
          bool4 = true;
      ...
      if (k == 0)
      {
        ...
        localObject11 = LikeBuilder.INSTANCE;
        localObject4 = LikeBuilder.readFromFission(paramFissionAdapter, null, (String)localObject4, paramFissionTransaction);
      ...
      if (k == 1)
      {
        localObject4 = LikeBuilder.INSTANCE;
        localObject4 = LikeBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject6, null, paramFissionTransaction);
        if (localObject4 == null) {
          break label1070;
        }
      }
    ...
    {
      if (i != 0) {
        ((List)localObject10).add(localObject4);
      }
      j -= 1;
      break label837;
      bool2 = false;
    ...
    if (((ByteBuffer)localObject6).get() == 1)
    {
      ...
      if (k == 0)
      {
        ...
        localObject11 = CommentBuilder.INSTANCE;
        localObject5 = CommentBuilder.readFromFission(paramFissionAdapter, null, (String)localObject5, paramFissionTransaction);
      ...
      if (k == 1)
      {
        localObject5 = CommentBuilder.INSTANCE;
        localObject5 = CommentBuilder.readFromFission(paramFissionAdapter, (ByteBuffer)localObject6, null, paramFissionTransaction);
        if (localObject5 == null) {
          break label1237;
        }
      }
    ...
    {
      if (i != 0) {
        ((List)localObject10).add(localObject5);
      }
      j -= 1;
      break label1112;
      bool12 = false;
    ...
    return new Update(paramString, (AnnotatedText)localObject1, (Update.Value)localObject2, str1, (Urn)localObject7, (Urn)localObject8, bool6, (TrackingData)localObject3, str2, (List)localObject4, (List)localObject5, paramFissionTransaction, bool1, bool2, bool3, bool7, bool8, bool9, bool10, bool4, bool5, bool11, bool12, bool13);
  }
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.UpdateBuilder
