...
public final class MemberActor
  implements FissileDataModel<MemberActor>, RecordTemplate<MemberActor>
{
  ...
  MemberActor(Urn paramUrn, MiniProfile paramMiniProfile, FollowingInfo paramFollowingInfo, boolean paramBoolean1, MemberDistance paramMemberDistance, boolean paramBoolean2, boolean paramBoolean3, boolean paramBoolean4, boolean paramBoolean5, boolean paramBoolean6)
  {
    urn = paramUrn;
  ...
  public final MemberActor accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    return new MemberActor(urn, (MiniProfile)localObject2, (FollowingInfo)localObject3, showFollowAction, (MemberDistance)localObject1, hasUrn, bool1, bool2, hasShowFollowAction, bool3);
    label387:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (MemberActor)paramObject;
      if (urn != null)
      {
        if (urn.equals(urn)) {}
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building MemberActor");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(105724544);
        if (hasUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.MemberActor
