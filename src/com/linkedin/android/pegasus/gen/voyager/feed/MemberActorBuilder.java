...
public final class MemberActorBuilder
  implements FissileDataModelBuilder<MemberActor>, DataTemplateBuilder<MemberActor>
{
  public static final MemberActorBuilder INSTANCE = new MemberActorBuilder();
  ...
  public static MemberActor build(DataReader paramDataReader)
    throws DataReaderException
  {
    ...
    if (!bool4) {
      throw new DataReaderException("Failed to find required field: miniProfile when building com.linkedin.android.pegasus.gen.voyager.feed.MemberActor");
    }
    if (!bool2) {
      throw new DataReaderException("Failed to find required field: followingInfo when building com.linkedin.android.pegasus.gen.voyager.feed.MemberActor");
    }
    return new MemberActor((Urn)localObject4, (MiniProfile)localObject3, (FollowingInfo)localObject2, bool6, (MemberDistance)localObject1, bool5, bool4, bool2, bool3, bool1);
  }
  
  public static MemberActor readFromFission(FissionAdapter paramFissionAdapter, ByteBuffer paramByteBuffer, String paramString, FissionTransaction paramFissionTransaction)
    throws IOException
  {
    if ((paramByteBuffer == null) && (paramString == null)) {
      throw new IOException("Cannot read without at least one of key or input byteBuffer when building MemberActor");
    }
    ...
    if (paramString != null)
    {
      ...
      throw new IOException("Invalid header prefix. Can't read cached data when building MemberActor");
    }
    ...
    if (((ByteBuffer)localObject3).getInt() != 105724544)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject3);
      throw new IOException("UID mismatch. Can't read cached data when building MemberActor");
    }
    Object localObject4 = null;
    paramString = null;
    ...
    for (boolean bool4 = true;; bool4 = false)
    {
      ...
      throw new IOException("Failed to find required field: miniProfile when reading com.linkedin.android.pegasus.gen.voyager.feed.MemberActor from fission.");
      bool6 = false;
      break;
      bool2 = false;
      break label267;
    ...
    label684:
    if (!bool2) {
      throw new IOException("Failed to find required field: followingInfo when reading com.linkedin.android.pegasus.gen.voyager.feed.MemberActor from fission.");
    }
    return new MemberActor((Urn)localObject4, paramString, (FollowingInfo)localObject1, bool5, (MemberDistance)localObject2, bool6, bool1, bool2, bool7, bool4);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.MemberActorBuilder
