...
public final class DiscussionUpdateContent
  implements FissileDataModel<DiscussionUpdateContent>, RecordTemplate<DiscussionUpdateContent>
{
  ...
  DiscussionUpdateContent(Content paramContent, boolean paramBoolean)
  {
  ...
  private DiscussionUpdateContent accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.feed.DiscussionUpdateContent", "content");
      }
    ...
    label115:
    return new DiscussionUpdateContent(localContent, bool);
    label125:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (DiscussionUpdateContent)paramObject;
      if (content == null) {
        break;
      }
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building DiscussionUpdateContent");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-772304255);
        if (hasContent)
        {
          localByteBuffer.put((byte)1);
          if (content._cachedId != null)
    ...
    implements FissileDataModel<Content>, UnionTemplate<Content>
  {
    ...
    Content(DiscussionBase paramDiscussionBase, DiscussionWithArticle paramDiscussionWithArticle, DiscussionWithImage paramDiscussionWithImage, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
    {
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.DiscussionUpdateContent
