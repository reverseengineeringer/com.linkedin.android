...
public final class UnfollowChannel
  implements FissileDataModel<UnfollowChannel>, RecordTemplate<UnfollowChannel>
{
  ...
  UnfollowChannel(Urn paramUrn, String paramString, FollowingInfo paramFollowingInfo, boolean paramBoolean1, boolean paramBoolean2, boolean paramBoolean3)
  {
    channelUrn = paramUrn;
    displayName = paramString;
    followingInfo = paramFollowingInfo;
    hasChannelUrn = paramBoolean1;
    hasDisplayName = paramBoolean2;
    hasFollowingInfo = paramBoolean3;
    _cachedId = null;
  }
  
  public final UnfollowChannel accept(DataProcessor paramDataProcessor)
    throws DataProcessorException
  {
    paramDataProcessor.startRecord();
    if (hasChannelUrn)
    {
      paramDataProcessor.startRecordField$505cff1c("channelUrn");
      localObject = UrnCoercer.INSTANCE;
      paramDataProcessor.processString(UrnCoercer.coerceFromCustomType(channelUrn));
    }
    if (hasDisplayName)
    {
    ...
    for (bool = true;; bool = false)
    {
      ...
      try
      {
        ...
        throw new MissingRecordFieldException("com.linkedin.android.pegasus.gen.voyager.feed.actions.UnfollowChannel", "channelUrn");
      }
    ...
    label172:
    return new UnfollowChannel(channelUrn, displayName, (FollowingInfo)localObject, hasChannelUrn, hasDisplayName, bool);
    label198:
    return null;
  }
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    do
    {
      ...
      paramObject = (UnfollowChannel)paramObject;
      if (channelUrn != null)
      {
        if (channelUrn.equals(channelUrn)) {}
      }
      else {
        while (channelUrn != null) {
          return false;
        }
      }
      if (displayName != null)
  ...
  public final int getSerializedSize()
  {
    ...
    if (hasChannelUrn)
    {
      ...
      i = PegasusBinaryUtils.getEncodedLength(UrnCoercer.coerceFromCustomType(channelUrn)) + 8;
    }
    int j = i + 1;
    i = j;
    if (hasDisplayName) {
    ...
    throws IOException
  {
    ...
    if ((str == null) && (paramString == null) && (paramByteBuffer == null)) {
      throw new IOException("Cannot write model without at least one of ID/CacheKey/ByteBuffer to fission when building UnfollowChannel");
    }
    if (paramBoolean)
    {
      if (paramString != null) {
    ...
    do
    {
      ...
      for (;;)
      {
        ...
        localByteBuffer.putInt(-1957879041);
        if (hasChannelUrn)
        {
          localByteBuffer.put((byte)1);
          UrnCoercer localUrnCoercer = UrnCoercer.INSTANCE;
          paramFissionAdapter.writeString(localByteBuffer, UrnCoercer.coerceFromCustomType(channelUrn));
          if (!hasDisplayName) {
            break label273;
          }
          localByteBuffer.put((byte)1);
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.voyager.feed.actions.UnfollowChannel
