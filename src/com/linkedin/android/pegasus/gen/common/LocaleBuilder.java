  ...
  implements FissileDataModelBuilder<Locale>, DataTemplateBuilder<Locale>
{
    ...
    throws DataReaderException
  {
    ...
    if (!bool3) {
      throw new DataReaderException("Failed to find required field: language when building com.linkedin.android.pegasus.gen.common.Locale");
    }
    ...
    throws IOException
  {
    ...
    label170:
    if (((ByteBuffer)localObject1).getInt() != -1983216830)
    {
      paramFissionAdapter.recycle((ByteBuffer)localObject1);
    ...
    for (;;)
    {
      ...
      throw new IOException("Failed to find required field: language when reading com.linkedin.android.pegasus.gen.common.Locale from fission.");
      bool1 = false;
      break;
      label314:
      bool2 = false;
...
/* Location:
 * Qualified Name:     com.linkedin.android.pegasus.gen.common.LocaleBuilder
