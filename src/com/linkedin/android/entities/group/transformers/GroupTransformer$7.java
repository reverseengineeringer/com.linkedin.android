...
final class GroupTransformer$7
  implements Closure<ImpressionData, TrackingEventBuilder>
{
  GroupTransformer$7(Map paramMap, String paramString, TrackingObject paramTrackingObject) {}
  ...
  private TrackingEventBuilder apply(ImpressionData paramImpressionData)
  {
    ...
    paramImpressionData = new FlagshipGroupItemImpressionEvent.Builder().setGroup(val$parentTrackingObject).setItems(localArrayList);
    return paramImpressionData;
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.entities.group.transformers.GroupTransformer.7
