...
public final class MeWvmpIntentBuilder
  extends IntentFactory<MeWvmpBundleBuilder>
  implements DeeplinkIntent
{
  ...
  {
    return new Intent(paramContext, MeWvmpActivity.class);
  }
}

/* Location:
 * Qualified Name:     com.linkedin.android.identity.me.wvmp.MeWvmpIntentBuilder
