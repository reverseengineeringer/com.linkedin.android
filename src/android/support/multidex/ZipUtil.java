...
final class ZipUtil
{
  private static long computeCrcOfCentralDir(RandomAccessFile paramRandomAccessFile, CentralDirectory paramCentralDirectory)
    throws IOException
  {
  ...
  private static CentralDirectory findCentralDirectory(RandomAccessFile paramRandomAccessFile)
  ...
  static final class CentralDirectory
  {
    long offset;
    long size;
  }
