...
final class ICustomTabsCallback$Stub$Proxy
  implements ICustomTabsCallback
{
  ...
  /* Error */
  public final void extraCallback(String paramString, android.os.Bundle paramBundle)
  ...
  /* Error */
  public final void onNavigationEvent(int paramInt, android.os.Bundle paramBundle)
    throws android.os.RemoteException
  {
    // Byte code:
    //   0: invokestatic 32	android/os/Parcel:obtain	()Landroid/os/Parcel;
