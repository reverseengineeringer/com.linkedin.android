...
final class MediaBrowserServiceCompat$ServiceImpl$1
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    MediaBrowserServiceCompat.ConnectionRecord localConnectionRecord = new MediaBrowserServiceCompat.ConnectionRecord(this$1.this$0, (byte)0);
    pkg = val$pkg;
    rootHints = val$rootHints;
    callbacks = val$callbacks;
    root = this$1.this$0.onGetRoot$16f11348();
    if (root == null) {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        {
          val$callbacks.onConnect(root.mRootId, this$1.this$0.mSession, root.mExtras);
          return;
        }
      }
