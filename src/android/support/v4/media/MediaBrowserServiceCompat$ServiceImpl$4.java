...
final class MediaBrowserServiceCompat$ServiceImpl$4
  implements Runnable
{
  ...
  public final void run()
  {
    ...
    while (MediaBrowserServiceCompat.access$800$37d33af6(val$id, (MediaBrowserServiceCompat.ConnectionRecord)localObject, val$options)) {
      return;
    }
