  ...
  implements Drawable.Callback, DrawableWrapper, TintAwareDrawable
{
  ...
  {
    return new DrawableWrapperStateDonut(mState);
  }
    ...
    extends Drawable.ConstantState
  {
    ...
    DrawableWrapperState(DrawableWrapperState paramDrawableWrapperState)
    {
  ...
  private static final class DrawableWrapperStateDonut
    extends DrawableWrapperDonut.DrawableWrapperState
  {
    DrawableWrapperStateDonut(DrawableWrapperDonut.DrawableWrapperState paramDrawableWrapperState)
    {
      super();
    }
