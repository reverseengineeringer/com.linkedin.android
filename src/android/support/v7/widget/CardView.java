  ...
  extends FrameLayout
{
  ...
  private final CardViewDelegate mCardViewDelegate = new CardViewDelegate()
  {
    ...
    public final void setCardBackground(Drawable paramAnonymousDrawable)
    {
      mCardBackground = paramAnonymousDrawable;
      setBackgroundDrawable(paramAnonymousDrawable);
    }
    
    public final void setMinWidthHeightInternal(int paramAnonymousInt1, int paramAnonymousInt2)
    {
    ...
    public final void setShadowPadding(int paramAnonymousInt1, int paramAnonymousInt2, int paramAnonymousInt3, int paramAnonymousInt4)
    {
