...
final class ScrollingTabContainerView$TabView
  ...
  implements View.OnLongClickListener
{
  ...
  public ScrollingTabContainerView$TabView(ScrollingTabContainerView paramScrollingTabContainerView, Context paramContext, ActionBar.Tab paramTab)
  {
    super(paramContext, null, R.attr.actionBarTabStyle);
    mTab = paramTab;
    paramScrollingTabContainerView = TintTypedArray.obtainStyledAttributes$89ace2b(paramContext, null, BG_ATTRS, R.attr.actionBarTabStyle);
